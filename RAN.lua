...
local NameUser = "*◜#ُِ︙بواسطه »* ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "*◜#ُِ︙اسم المستخدم »* ["..data.first_name_.."](T.me/"..UserName..")"
if status == "reply" then
send(msg.chat_id_, msg.id_,NameUserr.."\n"..text)
return false
end
else
send(msg.chat_id_, msg.id_,"◜#ُِ︙الحساب محذوف يرجى استخدام الامر بصوره صحيحه")
end
end,nil)   
end 
...
send(chat,msg.id_,"* ◜#ُِ︙ملف نسخه ليس لهاذا البوت*")
return false 
end  
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_," *◜#ُِ︙جاري ...*\n*◜#ُِ︙رفع الملف الان*")
else
send(chat,msg.id_,"* ◜#ُِ︙عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")
end  
...
send(chat,msg.id_,"\n *◜#ُِ︙تم رفع الملف بنجاح وتفعيل الكروبات*\n*◜#ُِ︙ورفع {الامنشئين الاساسين ; والمنشئين ; *والمدراء; والادمنيه} بنجاح")
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\n *◜#ُِ︙العضــو » '..Name..'*\n*◜#ُِ︙قام بالتكرار هنا وتم طرده* '  
...
Text = '\n *◜#ُِ︙العضــو » '..Name..'*\n*◜#ُِ︙قام بالتكرار هنا وتم تقييده* '  
sendText(msg.chat_id_,Text,0,'md')
return false  
end  
if type == 'mute' then
...
if text == "الغاء" or text == "الغاء ◜#ُِ" then   
send(msg.chat_id_, msg.id_," ◜#ُِ︙تم الغاء الاذاعه")
...
send(msg.chat_id_, msg.id_," ◜#ُِ︙تمت الاذاعه الى *~ "..#list.." ~* كروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
if DevRANW(msg) then
local bl = ' *◜#ُِ︙اهلا عزيزي آلمـطـور*\n*◜#ُِ︙آنت آلمـطـور آلآسـآسـي للبوت*\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n*◜#ُِ︙تسـتطـيع‌‏ آلتحگم باوامر البوت*\n*◜#ُِ︙من خلاال الكيبورت خاص بك*\n*◜#ُِ︙قناة سورس البوت *[اضغط هنا](t.me/KKKBK)'
local keyboard = {
{'الاحصائيات ◜#ُِ','قناه تحديثات البوت ◜#ُِ'},
{'تعطيل التواصل ◜#ُِ','تفعيل التواصل ◜#ُِ'},
{'ضع اسم للبوت ◜#ُِ','المطورين ◜#ُِ','قائمه العام ◜#ُِ'},
{'الثانويين ◜#ُِ','مسح الثانويين ◜#ُِ'},
{'المشتركين ◜#ُِ','الكروبات ◜#ُِ'},
{'ضع كليشه ستارت ◜#ُِ','حذف كليشه ستارت ◜#ُِ'},
{'اذاعه ◜#ُِ','اذاعه خاص ◜#ُِ'},
{'اذاعه بالتثبيت ◜#ُِ','قائمه الكتم العام ◜#ُِ'},
{'تغير رساله الاشتراك','حذف رساله الاشتراك ◜#ُِ','تغير الاشتراك'},
{'اذاعه بالتوجيه ◜#ُِ','اذاعه بالتوجيه خاص ◜#ُِ'},
{'تفعيل الاشتراك الاجباري ◜#ُِ','تعطيل الاشتراك الاجباري ◜#ُِ'},
{'الاشتراك الاجباري ◜#ُِ','وضع قناة الاشتراك ◜#ُِ'},
{'تفعيل البوت الخدمي ◜#ُِ','تعطيل البوت الخدمي ◜#ُِ'},
{'تنظيف الكروبات ◜#ُِ','تنظيف المشتركين ◜#ُِ'},
{'تفعيل النسخه التلقائيه ◜#ُِ','تعطيل النسخه التلقائيه ◜#ُِ'},
{'تغيير المطور الاساسي ◜#ُِ'}, 
{'جلب نسخه الاحتياطيه ◜#ُِ'},
{'تحديث السورس ◜#ُِ','الاصدار ◜#ُِ'},
{'معلومات السيرفر ◜#ُِ'},
{'الغاء ◜#ُِ'},
}
...
SourceRANr = '*◜#ُِ︙اهلا عزيزي*\n*◜#ُِ︙انا بوت اسمي '..Namot..'*\n*◜#ُِ︙اختصاصي حمايه الكروبات*\n*◜#ُِ︙من تكرار والسبام والتوجيه والخ…*\n*◜#ُِ︙لتفعيلي اتبع الاخطوات…↓*\n*◜#ُِ︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n◜#ُِ︙[قناة سورس البوت](http://t.me/KKKBK)'
end
...
send(msg.sender_user_id_, msg.id_,' *◜#ُِ︙تم ارسال رسالتك*\n*◜#ُِ︙سيتم رد في اقرب وقت*')
...
local Text = ' *◜#ُِ︙المستخدم » '..Name..'*\n*◜#ُِ︙تم حظره من التواصل*'
...
if text == 'تفعيل النسخه التلقائيه ◜#ُِ' and SudoBot(msg) then  
send(msg.chat_id_, msg.id_,"*◜#ُِ︙تم تفعيل النسخه الاحتياطيه التلقائيه*") 
database:del(bot_id.."AutoFile")
end
if text == 'تعطيل النسخه التلقائيه ◜#ُِ' and SudoBot(msg) then  
send(msg.chat_id_, msg.id_,"*◜#ُِ︙تم تعطيل النسخه الاحتياطيه التلقائيه*") 
database:set(bot_id.."AutoFile",true) 
end
if text == 'مسح الثانويين ◜#ُِ' and SudoBot(msg) then  
database:del(bot_id.."DEV:Sudo:T")
send(msg.chat_id_, msg.id_, "\n*◜#ُِ︙تم مسح قائمة المطورين الثانويين* ")
end
if text == 'الثانويين ◜#ُِ' and SudoBot(msg) then
local list = database:smembers(bot_id.."DEV:Sudo:T")
t = "\n*◜#ُِ︙قائمة مطورين الثانويين للبوت* \n *•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•* \n"
for k,v in pairs(list) do
...
if #list == 0 then
t = "*◜#ُِ︙لا يوجد مطورين ثانويين*"
end
send(msg.chat_id_, msg.id_, t)
end
if text == 'تفعيل التواصل ◜#ُِ' and DevRANW(msg) then  
if database:get(bot_id..'Tuasl:Bots') then
database:del(bot_id..'Tuasl:Bots') 
Text = '\n *◜#ُِ︙تم تفعيل التواصل* ' 
else
Text = '\n *◜#ُِ︙بالتاكيد تم تفعيل التواصل* '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل التواصل ◜#ُِ' and DevRANW(msg) then  
if not database:get(bot_id..'Tuasl:Bots') then
database:set(bot_id..'Tuasl:Bots',true) 
Text = '\n *◜#ُِ︙تم تعطيل التواصل*' 
else
Text = '\n *◜#ُِ︙بالتاكيد تم تعطيل التواصل*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل البوت الخدمي ◜#ُِ' and DevRANW(msg) then  
if database:get(bot_id..'Free:Bots') then
database:del(bot_id..'Free:Bots') 
Text = '\n *◜#ُِ︙تم تفعيل البوت الخدمي* ' 
else
Text = '\n *◜#ُِ︙بالتاكيد تم تفعيل البوت الخدمي* '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل البوت الخدمي ◜#ُِ' and DevRANW(msg) then  
if not database:get(bot_id..'Free:Bots') then
database:set(bot_id..'Free:Bots',true) 
Text = '\n *◜#ُِ︙تم تعطيل البوت الخدمي*' 
else
Text = '\n *◜#ُِ︙بالتاكيد تم تعطيل البوت الخدمي*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاء ◜#ُِ' then   
send(msg.chat_id_, msg.id_,' *◜#ُِ︙الغاء حفظ كليشه ستارت*')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم حفظ كليشه ستارت*')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'ضع كليشه ستارت ◜#ُِ' and DevRANW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *◜#ُِ︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ◜#ُِ' and DevRANW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ◜#ُِ' and DevRANW(msg) then 
...
send(msg.chat_id_,msg.id_, "*◜#ُِ︙تم تغيير المطور الاساسي بنجاح*")
...
send(msg.chat_id_,msg.id_, "*◜#ُِ︙عذرا صاحب الايدي لا يمتلك معرف ارسل ايدي اخر*")
end
end,nil)
end
end
if text =='تغيير المطور الاساسي ◜#ُِ' and SudoBot(msg) then
send(msg.chat_id_, msg.id_,'*◜#ُِ︙ ارسل ايدي المطور الاساسي الجديد*')
database:set(bot_id..'Ed:DevBots',true) 
end
if text =='تغيير المطور الاساسي ◜#ُِ' and not SudoBot(msg) then
send(msg.chat_id_, msg.id_,'*◜#ُِ︙لا يمكنك تغيير المطور الاساسي*')
end
if text == 'تحديث السورس ◜#ُِ' and DevRANW(msg) then 
os.execute('rm -rf RAN.lua')
os.execute('wget https://raw.githubusercontent.com/RAN-DEVL/RAN/main/RAN.lua')
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم تحديث السورس* \n*◜#ُِ︙لديك اخر اصدار لسورس ران*\n*◜#ُِ︙الاصدار » { 2.8v}*')
dofile('RAN.lua')  
end
if text == 'الاصدار ◜#ُِ' and DevRANW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *◜#ُِ︙اصدار سورس ران* \n*◜#ُِ︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ◜#ُِ' and DevRANW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ◜#ُِ︙[تحديثات البوت](t.me/GGGMG) \n◜#ُِ︙[قناه السورس](t.me/KKKBK)')
end
if text == "ضع اسم للبوت ◜#ُِ" and DevRANW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *◜#ُِ︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ◜#ُِ' and DevRANW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' الاحصائيات ◜#ُِ \n'..' *◜#ُِ︙عدد الكروبات » {'..Groups..'}'..'*\n *◜#ُِ︙عدد المشتركين » {'..Users..'}*'
send(msg.chat_id_, msg.id_,Text) 
return false
end
if text == 'المشتركين ◜#ُِ' and DevRANW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *◜#ُِ︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ◜#ُِ' and DevRANW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *◜#ُِ︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ◜#ُِ") and DevRANW(msg) then
...
if text == ("قائمه العام ◜#ُِ") and DevRANW(msg) then
local list = database:smembers(bot_id..'GBan:User')
t = "\n *◜#ُِ︙قائمه المحظورين عام* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = " *◜#ُِ︙لا يوجد محظورين عام*"
end
send(msg.chat_id_, msg.id_, t)
return false
end
if text == ("قائمه الكتم العام ◜#ُِ") and DevRANW(msg) then
local list = database:smembers(bot_id..'Gmute:User')
t = "\n *◜#ُِ︙قائمة المكتومين عام* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = " *◜#ُِ︙لا يوجد مكتومين عام*"
end
send(msg.chat_id_, msg.id_, t)
return false
end
if text=="اذاعه خاص ◜#ُِ" and msg.reply_to_message_id_ == 0 and DevRANW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *◜#ُِ︙ارسل الان اذاعتك؟* \n*◜#ُِ︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ◜#ُِ" and msg.reply_to_message_id_ == 0 and DevRANW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *◜#ُِ︙ارسل الان اذاعتك؟* \n*◜#ُِ︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ◜#ُِ" and msg.reply_to_message_id_ == 0 and DevRANW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *◜#ُِ︙ارسل الان اذاعتك؟* \n*◜#ُِ︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ◜#ُِ" and msg.reply_to_message_id_ == 0  and DevRANW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *◜#ُِ︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ◜#ُِ" and msg.reply_to_message_id_ == 0  and DevRANW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ◜#ُِ︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ◜#ُِ' and DevRANW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ◜#ُِ" and DevRANW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'*◜#ُِ︙لا يوجد مشتركين وهميين في البوت* \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'*◜#ُِ︙عدد المشتركين الان » ( '..#pv..' )*\n*◜#ُِ︙تم ازالة » ( '..sendok..' ) من المشتركين*\n*◜#ُِ︙الان عدد المشتركين الحقيقي » ( '..ok..' ) مشترك* \n')   
end
end
end,nil)
end,nil)
...
if text == "تنظيف الكروبات ◜#ُِ" and DevRANW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'*◜#ُِ︙لا يوجد كروبات وهميه في البوت*\n')   
else
local RAN = (w + q)
...
RAN = '\n*◜#ُِ︙تم ازالة »* { '..q..' } كروبات من البوت'
end
if w == 0 then
RANk = ''
else
RANk = '\n*◜#ُِ︙تم ازالة »* {'..w..'} كروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'*◜#ُِ︙عدد الكروبات الان » { '..#group..' }'..RANk..''..RAN..'*\n*◜#ُِ︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
send(msg.chat_id_,msg.id_," ◜#ُِ︙عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")
return false 
end  
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '*\n ◜#ُِ︙العضو »* ['..result.title_..'](t.me/'..(username or 'KKKBK')..')'
status  = '\n *◜#ُِ︙تم ترقيته مطور*'
texts = usertext..status
else
texts = ' *◜#ُِ︙لا يوجد حساب بهاذا المعرف*'
end
...
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*◜#ُِ︙تم ترقيته مطور*'
...
if RAN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *◜#ُِ︙العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KKKBK')..') \n ◜#ُِ︙'..RAN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
if text == 'الغاء' or text == 'الغاء ◜#ُِ' then   
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم الغاء حفظ اسم البوت*")
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
database:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, " *◜#ُِ︙تم حفظ الاسم*")
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء ◜#ُِ' then   
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم الغاء الاذاعه للخاص*")
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙تمت الاذاعه الى >>{"..#list.."} مشترك في البوت* ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙تمت الاذاعه الى >>{"..#list.."} كروب في البوت* ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙تمت الاذاعه الى >>{"..#list.."} كروبات في البوت* ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_, " *◜#ُِ︙تم الغاء الامر* ")
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙المعرف لا يوجد فيه قناة*')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙عذا لا يمكنك وضع معرف حسابات في الاشتراك* ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' *◜#ُِ︙عذا لا يمكنك وضع معرف كروب بالاشتراك* ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,' *◜#ُِ︙البوت ادمن في القناة* \n*◜#ُِ︙تم تفعيل الاشتراك الاجباري في* \n*◜#ُِ︙ايدي القناة ('..data.id_..')*\n*◜#ُِ︙معرف القناة* ([@'..data.type_.channel_.username_..'])')
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,' *◜#ُِ︙عذرآ البوت ليس ادمن بالقناه* ')
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم تغيير رسالة الاشتراك* ')
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙عذرآ البوت لايملك صلاحيات*')
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم تغيير صورة الكروب*')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم الغاء وضع الوصف*")
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
https.request('https://api.telegram.org/bot'..token..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم تغيير وصف الكروب*')
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم الغاء حفظ الترحيب*")
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم حفظ ترحيب الكروب*')
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_," *◜#ُِ︙تم الغاء حفظ الرابط*")
...
send(msg.chat_id_,msg.id_," *◜#ُِ︙تم حفظ الرابط بنجاح*")
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *◜#ُِ︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n◜#ُِ︙["..RAN_Msg.."] \n")
else
send(msg.chat_id_,0," *◜#ُِ︙العضو :* {["..data.first_name_.."](T.ME/KKKBK)}\n◜#ُِ︙["..RAN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, " *◜#ُِ︙عذرا »* {[@"..data.username_.."]}\n*◜#ُِ︙عذرا تم منع الملصق* \n" ) 
else
send(msg.chat_id_,0, " *◜#ُِ︙عذرا »* {["..data.first_name_.."](T.ME/KKKBK)}\n*◜#ُِ︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false   
...
send(msg.chat_id_, msg.id_,' ◜#ُِ︙عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevRANW(msg) then
send(msg.chat_id_, msg.id_,' *◜#ُِ︙عدد اعضاء الكروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو*')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' *◜#ُِ︙بالتأكيد تم تفعيل الكروب*')
else
sendText(msg.chat_id_,'\n *◜#ُِ︙بواسطه »* ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n*◜#ُِ︙تم تفعيل الكروب *{'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = ' *◜#ُِ︙تم تفعيل كروب جديده*\n'..
'\n *◜#ُِ︙بواسطة* {'..Name..'}'..
'\n *◜#ُِ︙ايدي الكروب* {'..IdChat..'}'..
'\n *◜#ُِ︙اسم الكروب* {['..NameChat..']}'..
'\n *◜#ُِ︙عدد اعضاء الكروب* *{'..NumMember..'}*'..
'\n *◜#ُِ︙الرابط* {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙بالتأكيد تم تعطيل الكروب*')
else
sendText(msg.chat_id_,'\n *◜#ُِ︙بواسطه »* ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n*◜#ُِ︙تم تعطيل الكروب *{'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم تفعيل الكروب*')
else
sendText(msg.chat_id_,'\n *◜#ُِ︙بواسطه »* ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n*◜#ُِ︙تم تفعيل الكروب *{'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم تعيين عدد الاعضاء سيتم تفعيل الكروبات التي اعضائها اكثر من  >> {'..Num..'} عضو*')
end
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevRANW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ◜#ُِ" and DevRANW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *◜#ُِ︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ◜#ُِ$") and DevRANW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ◜#ُِ" and DevRANW(msg) then  
if database:get(bot_id..'add:ch:id') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_," *◜#ُِ︙الاشتراك الاجباري مفعل* \n*◜#ُِ︙على القناة »* ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_," ◜#ُِ︙اهلا عزيزي المطور \n ◜#ُِ︙ارسل الان معرف قناتك")
end
return false  
end
if text == "تعطيل الاشتراك الاجباري ◜#ُِ" and DevRANW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *◜#ُِ︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ◜#ُِ" and DevRANW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *◜#ُِ︙تم تفعيل الاشتراك الاجباري* \n*◜#ُِ︙على القناة »* ["..addchusername.."]")
else
send(msg.chat_id_, msg.id_, " *◜#ُِ︙لا يوجد قناة في الاشتراك الاجباري* ")
end
return false  
end
if text == "تفعيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '*◜#ُِ︙ تم تفعيل الاضافات*')
database:set(bot_id.."AL:Sre:stats","✔")
end
if text == "تعطيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '*◜#ُِ︙ تم تعطيل الاضافات*')
database:set(bot_id.."AL:Sre:stats","❌")
end
...
send(msg.chat_id_, msg.id_, '*◜#ُِ︙تم كتم الاسم* '..BlNe)
...
send(msg.chat_id_, msg.id_, '*◜#ُِ︙تم الغاء كتم الاسم* '..delBn)
...
texts = "*◜#ُِ︙تم مسح الاسماء المكتومه* "
send(msg.chat_id_, msg.id_, texts)
end
...
t = "\n*◜#ُِ︙قائمة الاسماء المكتومه* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(All_name) do
t = t..""..k.."- (["..v.."])\n"
end
if #All_name == 0 then
t = "*◜#ُِ︙لا يوجد اسماء مكتومه*"
end
send(msg.chat_id_, msg.id_, t)
end
end
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:Sre:stats") == "✔" then
send(msg.chat_id_, msg.id_, '*◜#ُِ︙تم التفعيل الاسماء المكتومه*')
...
send(msg.chat_id_, msg.id_, '*◜#ُِ︙تم تعطيل الاسماء المكتومه*')
...
send(msg.chat_id_, msg.id_,'*◜#ُِ︙تم تعيين '..teh..' كتوحيد للمجموعه*')
...
send(msg.chat_id_, msg.id_,'*◜#ُِ︙تم تعين  '..nump..' عدد الكتم*')
...
send(msg.chat_id_, msg.id_,'*◜#ُِ︙التوحيد '..s1..'*\n*◜#ُِ︙عدد الكتم  :* '..s2)
end
end
if text == "تفعيل التوحيد" and Constructor(msg) and database:get(bot_id.."AL:Sre:stats") == "✔" then
send(msg.chat_id_, msg.id_, '*◜#ُِ︙تم تفعيل التوحيد*')
...
send(msg.chat_id_, msg.id_, '*◜#ُِ︙تم تعطيل التوحيد*')
...
send(msg.chat_id_, msg.id_, "◜#ُِ︙عزيزي >>["..RAN2.username_.."](https://t.me/"..(RAN2.username_ or "KKKBK")..")\n◜#ُِ︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."RAN:teh"..msg.chat_id_).."} بجانب اسمك\n◜#ُِ︙عدد المحاولات المتبقيه {"..(tonumber(RAN_nnn) - tonumber(RAN_nnn2)).."}")
end
end
end
end
...
send(msg.chat_id_, msg.id_, '*◜#ُِ︙تم تفعيل تنبيه الاسماء*')
...
send(msg.chat_id_, msg.id_, '*◜#ُِ︙تم تعطيل تنبيه الاسماء*')
...
send(msg.chat_id_, msg.id_, '*◜#ُِ︙تم تفعيل تنبيه المعرف*')
...
send(msg.chat_id_, msg.id_, '*◜#ُِ︙تم تعطيل تنبيه المعرف*')
...
send(msg.chat_id_, msg.id_, '*◜#ُِ︙تم تفعيل تنبيه الصور*')
...
send(msg.chat_id_, msg.id_, '*◜#ُِ︙تم تعطيل تنبيه الصور*')
...
Text = [[
*أهلاً بك في السوࢪس* [ٌ~ 𝙎ٌ𝙊ٌِّ𝙐𝙍ٌٍ𝘾𝙀 ُ𝙍 𝘼 𝙉 .💘](t.me/GGGMG)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السوࢪس 💘',url="https://t.me/GGGMG"},
},
{
{text = 'لتنصيب السوࢪس 💘',url="https://t.me/GGGMG/3"},
},
{
{text = 'مطوࢪ السوࢪس 💘',url="t.me/ooouo"},
},
{
{text = 'تواصل السوࢪس 💘',url="t.me/R77Bot"},
},
}
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم ازالة جميع الاوامر المضافه*')  
end
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙ارسل الامر القديم*')  
return false
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙ارسل الامر الذي قمت بوضعه بدلا عن القديم*')  
return false
end
end
if text and database:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
database:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,' *◜#ُِ︙ارسل الامر الجديد*')  
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم حفظ الامر*')  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *◜#ُِ︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KKKBK')..') \n*◜#ُِ︙تـم قفـل الدردشه* ')
end,nil)   
...
Text = ' *◜#ُِ︙تم تفعيل نسبه الحب*'
database:del(bot_id..'Cick:lov'..msg.chat_id_)  
else
Text = ' *◜#ُِ︙بالتاكيد تم تفعيل نسبه الحب*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *◜#ُِ︙تم تعطيل نسبه الانوثه*'
else
Text = '\n *◜#ُِ︙بالتاكيد تم تعطيل نسبه الانوثه*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل غنيلي' and CoSu(msg) then   
if database:get(bot_id..'sing:for:me'..msg.chat_id_) then
Text = ' *◜#ُِ︙تم تفعيل امر غنيلي الان ارسل غنيلي*'
database:del(bot_id..'sing:for:me'..msg.chat_id_)  
else
Text = ' *◜#ُِ︙بالتاكيد تم تفعيل امر غنيلي تستطيع ارسال غنيلي*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *◜#ُِ︙تم تعطيل امر غنيلي*'
else
Text = '\n *◜#ُِ︙بالتاكيد تم تعطيل امر غنيلي*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *◜#ُِ︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KKKBK')..') \n*◜#ُِ︙تـم قفـل التاك بالتقييد* ')
end,nil)   
elseif text == 'قفل التاك بالكتم' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'ktm')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *◜#ُِ︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'KKKBK')..') \n*◜#ُِ︙تـم قفـل التاك بالكتم* ')
end,nil)   
elseif text == 'قفل التاك بالطرد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'kick')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *◜#ُِ︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KKKBK')..') \n*◜#ُِ︙تـم قفـل التاك بالطرد* ')
end,nil)   
...
send(msg.chat_id_, msg.id_,"*◜#ُِ︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " *◜#ُِ︙لا تسطيع حظر البوت عام*")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " *◜#ُِ︙لا تسطيع كتم البوت عام*")
return false 
end
...
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*◜#ُِ︙تم الغاء (الحظر-الكتم) عام من الكروبات*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
send(msg.chat_id_, msg.id_, "\n *◜#ُِ︙تم مسح قائمة المطورين*  ")
end
if text == ("المطورين") and DevRANW(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n *◜#ُِ︙قائمة مطورين البوت* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if Get_info then
local TextS = "\n *◜#ُِ︙اهلا بك في متجر ملفات ران*\n*◜#ُِ︙ملفات السورس ↓*\n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n *◜#ُِ︙علامة تعني { ✓ } ملف مفعل*\n *◜#ُِ︙علامة تعني { ✘ } ملف معطل*\n *◜#ُِ︙قناة سورس ران ↓*\n".." *◜#ُِ︙*[اضغط هنا لدخول](t.me/KKKBK) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙لا يوجد اتصال من ال api* \n") 
end
return false
end
end
...
t = " *◜#ُِ︙بالتاكيد تم تعطيل ملف →* "..file.."\n"
end
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙عذرا الملف لايدعم سورس ران* \n") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = " *◜#ُِ︙بالتاكيد تم تفعيل ملف →* "..file.." \n"
else
t = " *◜#ُِ︙الملف »* "..file.."\n*◜#ُِ︙تم تفعيل ملف* \n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/RAN-DEVL/Files_RAN/main/File_Bot/"..file)
...
send(msg.chat_id_,msg.id_," *◜#ُِ︙تم مسح الملفات*")
return false
end
...
if #list == 0 then
t = " *◜#ُِ︙لا يوجد احد في قائمه المالك*"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
t = "*◜#ُِ︙المنشئين الاساسين تعالو مخرب* \n *•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•* \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = "*◜#ُِ︙ماكو منششئين يشوفولك جاره*"
end
Reply_Status(msg,msg.sender_user_id_,"reply","*◜#ُِ︙قام بنشر ملصق اباحيه*\n"..t)  
...
Reply_Status(msg,msg.sender_user_id_,"reply","*◜#ُِ︙قام بنشر صوره اباحيه*\n"..t)  
DeleteMessage(msg.chat_id_,{[0] = tonumber(msg.id_),msg.id_})   
end   
end
if text == 'المنشئين الاساسين' and CoSu(msg) then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n *◜#ُِ︙قائمة المنشئين الاساسين* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙حساب المنشئ محذوف*")
return false  
end
local UserName = (b.username_ or "KKKBK")
send(msg.chat_id_, msg.id_," ◜#ُِ︙منشئ الكروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," *◜#ُِ︙لا يوجد ادمنيه ليتم رفعهم*") 
else
send(msg.chat_id_, msg.id_," *◜#ُِ︙تمت ترقيه { "..num2.." } من الادمنيه*") 
end
end,nil)   
end
...
Reply_Status(msg,result.sender_user_id_,"reply","*◜#ُِ︙تم ترقيته مطور ثانوي في البوت*")  
end
...
Reply_Status(msg,result.id_,"reply","*◜#ُِ︙تم ترقيته مطور ثانوي في البوت*")  
else
send(msg.chat_id_, msg.id_,"*◜#ُِ︙لا يوجد حساب بهاذا المعرف*")
end
end
...
Reply_Status(msg,userid,"reply","*◜#ُِ︙تم ترقيته مطور ثانوي في البوت*")  
return false 
end
if text == ("تنزيل مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
function Function_RAN(extra, result, success)
database:srem(bot_id.."DEV:Sudo:T", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","*◜#ُِ︙تم تنزيله من المطور ثانويين*")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_RAN, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","*◜#ُِ︙تم تنزيله من المطور ثانويين*")  
else
send(msg.chat_id_, msg.id_,"*◜#ُِ︙لا يوجد حساب بهاذا المعرف*")
end
end
...
Reply_Status(msg,userid,"reply","*◜#ُِ︙تم تنزيله من المطور ثانويين*")  
return false 
end
...
send(msg.chat_id_, msg.id_, ' ◜#ُِ︙تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم تعطيل الرفع*') 
return false
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم تعطيل الطرد*') 
return false
end
function start_function(extra, result, success)
if RANSudoBot(result.sender_user_id_) then
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " *◜#ُِ︙لا تسطيع طرد البوت* ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n *◜#ُِ︙عذرا لا تستطيع طرد* ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' *◜#ُِ︙ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !*') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' *◜#ُِ︙البوت ليس ادمن يرجى ترقيتي !*') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
...
send(msg.chat_id_, msg.id_, '\n *◜#ُِ︙عذرا لا تستطيع طرد* ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"*◜#ُِ︙عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !*")   
...
send(msg.chat_id_, msg.id_, '\n *◜#ُِ︙عذرا لا تستطيع طرد* ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙تم مسح المميزين*')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n *◜#ُِ︙قائمة مميزين الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *◜#ُِ︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*◜#ُِ︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *◜#ُِ︙العضو »* '..userid..''
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙تم مسح جميع المطايه*')
end
if text == ("تاك للمطايه") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n *◜#ُِ︙قائمة مطايه الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n*◜#ُِ︙تم رفع العضو مطي في الكروب* \n*◜#ُِ︙تعال حبي استلم العربانه*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*◜#ُِ︙تم تنزيل العضو مطي في الكروب*\n*◜#ُِ︙تعال حبي رجع العربانه*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n*◜#ُِ︙تم رفع العضــو الحاته في الكروب* \n*◜#ُِ︙تعال يحاته ممكن نتعرف*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*◜#ُِ︙تم تنزيل العضــو الحاته من الكروب*\n*◜#ُِ︙مشيي مو خوش حاتهه*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n*◜#ُِ︙تم رفع العضــو الحات في الكروب* \n*◜#ُِ︙تعال حبي الحات نطيني بوسه*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*◜#ُِ︙تم تنزيل العضــو الحات من الكروب*\n*◜#ُِ︙مشيي مو خوش حات*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙تم تنزيل جميع صخوله من الكروب*')
end
if text == ("تاك للصخوله") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n *◜#ُِ︙قائمة صخوله الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local  statuss  = '\n*◜#ُِ︙تم رفع المتهم صخل بالكروب*\n*◜#ُِ︙الان اصبح صخل الكروب*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙تم تنزيل جميع جلاب الكروب*')
end
if text == ("تاك للجلاب") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n *◜#ُِ︙قائمة الجلاب الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local  statuss  = '\n*◜#ُِ︙تم رفع جلب في الكروب*\n*◜#ُِ︙تعال حبي اطيك عضمه*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙تم تنزيل جميع القروده بالكروب*')
end
if text == ("تاك للقروده") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n *◜#ُِ︙قائمة القروده الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local  statuss  = '\n*◜#ُِ︙تم رفع قرد في الكروب*\n*◜#ُِ︙تعال حبي استلم موزه*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local  statuss  = '\n*◜#ُِ︙تم رفع حصان في الكروب*\n*◜#ُِ︙تعال حبي احطلك سرج وركبك فرني فره حلوه*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙تم تنزيل جميع البقرات بالكروب*')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n *◜#ُِ︙قائمة البقرات الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local  statuss  = '\n*◜#ُِ︙تم رفع بقره في الكروب*\n*◜#ُِ︙ها يالهايشه تع احلبك*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*◜#ُِ︙تم تنزيل بقره من الكروب*\n*◜#ُِ︙تعال هاك حليب مالتك*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙تم تنزيل جميع طليان بالكروب')
end
if text == ("تاك للطليان") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n *◜#ُِ︙قائمة الطليان الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local  statuss  = '\n*◜#ُِ︙تم رفع الطلي في الكروب*\n*◜#ُِ︙طلع برا ابو البعرور الوصخ*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙تم تنزيل جميع زواحف*')
end
if text == ("تاك للزواحف") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n *◜#ُِ︙قائمة الزواحف الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local  statuss  = '\n*◜#ُِ︙تم رفع زاحف في الكروب*\n*◜#ُِ︙كمشتك حبي جيب رقم*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*◜#ُِ︙تم تنزيل زاحف من الكروب*\n*◜#ُِ︙هاك حبي هاذا رقم مالك*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙تم تنزيل جميع جريزي*')
end
if text == ("تاك للجريذيه") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n *◜#ُِ︙قائمة الجريذيه الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local  statuss  = '\n*◜#ُِ︙تم رفع جريذي في الكروب*\n*◜#ُِ︙خايس ريحتك موتتنه روح سبح يع*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم تعطيل الحظر*') 
return false
end
function start_function(extra, result, success)
if RANSudoBot(result.sender_user_id_) then
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " *◜#ُِ︙لا تسطيع حظر البوت* ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n *◜#ُِ︙عذرا لا تستطيع حظر* ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n *◜#ُِ︙عذرا لا تستطيع حظر* ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," *◜#ُِ︙عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !*")   
...
usertext = '\n *◜#ُِ︙ المستخدم »* ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n*◜#ُِ︙تم حظره*'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n *◜#ُِ︙عذرا لا تستطيع حظر* ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' *◜#ُِ︙ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !*') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙انا لست محظورآ* \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙تم مسح المكتومين*')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " *◜#ُِ︙لا تسطيع كتم البوت* ")
return false 
end
if RANSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*◜#ُِ︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
...
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n *◜#ُِ︙عذرا لا تستطيع كتم* ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' *◜#ُِ︙البوت ليس ادمن يرجى ترقيتي !*') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n *◜#ُِ︙عذرا لا تستطيع كتم* ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," *◜#ُِ︙عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !*")   
return false 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*◜#ُِ︙تم كتم لمدة ~* { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n *◜#ُِ︙عذرا لا تستطيع كتم* ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' *◜#ُِ︙البوت ليس ادمن يرجى ترقيتي !*') 
return false  
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " ◜#ُِ︙لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n *◜#ُِ︙عذرا لا تستطيع تقيد* ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n *◜#ُِ︙عذرا لا تستطيع تقيد* ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*◜#ُِ︙تم تقيده لمدة ~* { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n *◜#ُِ︙عذرا لا تستطيع تقيد* ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙ العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*◜#ُِ︙ الايدي »* `'..result.sender_user_id_..'`\n*◜#ُِ︙ تم رفعه مشرف* '
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◜#ُِ︙ العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*◜#ُِ︙ الايدي »* '..result.sender_user_id_..'\n*◜#ُِ︙ تم تنزيله ادمن من الكروب بكل الصلاحيات*'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
local text = 
'\n *◜#ُِ︙اعدادات الكروب كتالي √↓*'..
'\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n*◜#ُِ︙ علامة ال {✓} تعني معطل*'..
'\n*◜#ُِ︙ علامة ال {✘} تعني مفعل*'..
'\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n*◜#ُِ︙ الروابط »* { '..lock_links..
' }\n'..'*◜#ُِ︙ المعرفات »* { '..lock_user..
' }\n'..'*◜#ُِ︙ التاك »* { '..lock_hash..
' }\n'..'*◜#ُِ︙ البوتات »* { '..lock_bots..
' }\n'..'*◜#ُِ︙ التوجيه »* { '..lock_fwd..
' }\n'..'*◜#ُِ︙ التثبيت »* { '..lock_pin..
' }\n'..'*◜#ُِ︙ الاشعارات »* { '..lock_tagservr..
' }\n'..'*◜#ُِ︙ الماركدون »* { '..lock_mark..
' }\n'..'*◜#ُِ︙ التعديل »* { '..lock_edit..
' }\n'..'*◜#ُِ︙ تعديل الميديا »* { '..lock_edit_med..
' }\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n'..'*◜#ُِ︙ الكلايش »* { '..lock_spam..
' }\n'..'*◜#ُِ︙ الكيبورد »* { '..lock_inlin..
' }\n'..'*◜#ُِ︙ الاغاني »* { '..lock_vico..
' }\n'..'*◜#ُِ︙ المتحركه »* { '..lock_gif..
' }\n'..'*◜#ُِ︙ الملفات »* { '..lock_file..
' }\n'..'*◜#ُِ︙ الدردشه »* { '..lock_text..
' }\n'..'*◜#ُِ︙  الفيديو »* { '..lock_ved..
' }\n'..'*◜#ُِ︙  الصور »* { '..lock_photo..
' }\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n'..'*◜#ُِ︙  الصوت »* { '..lock_muse..
' }\n'..'*◜#ُِ︙ الملصقات »* { '..lock_ste..
' }\n'..'*◜#ُِ︙ الجهات »* { '..lock_phon..
' }\n'..'*◜#ُِ︙ الدخول »* { '..lock_join..
' }\n'..'*◜#ُِ︙ الاضافه »* { '..lock_add..
' }\n'..'*◜#ُِ︙ السيلفي »* { '..lock_self..
' }\n'..'*◜#ُِ︙ الالعاب »* { '..lock_geam..
' }\n'..'*◜#ُِ︙ التكرار »* { '..flood..
' }\n'..'*◜#ُِ︙ الترحيب »* { '..welcome..
' }\n'..'*◜#ُِ︙ عدد التكرار »* { '..NUM_MSG_MAX..
' }\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n*◜#ُِ︙ علامة ال {✓} تعني مفعل*'..
'\n*◜#ُِ︙ علامة ال {✘} تعني معطل*'..
'\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n'..'*◜#ُِ︙ امر صيح »* { '..kickme..
' }\n'..'*◜#ُِ︙ امر اطردني »* { '..sehuser..
' }\n'..'*◜#ُِ︙ امر منو ضافني »* { '..addme..
' }\n'..'*◜#ُِ︙ ردود المدير »* { '..rdmder..
' }\n'..'*◜#ُِ︙ ردود المطور »* { '..rdsudo..
' }\n'..'*◜#ُِ︙ الايدي »* { '..idgp..
' }\n'..'*◜#ُِ︙ الايدي بالصوره »* { '..idph..
' }\n'..'*◜#ُِ︙ الرفع »* { '..setadd..
' }\n'..'*◜#ُِ︙ الحظر »* { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n *◜#ُِ︙ CH » @KKKBK*\n'
send(msg.chat_id_, msg.id_,text) 
end
...
send(msg.chat_id_,msg.id_," *◜#ُِ︙عذرآ تم قفل التثبيت*")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم تثبيت الرساله*")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_," *◜#ُِ︙انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله*")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_," *◜#ُِ︙لا توجد رساله مثبته*")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," *◜#ُِ︙ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات*")  
end
end,nil) 
end
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_," *◜#ُِ︙عذرآ تم قفل الثبيت*")  
return false  
end
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم الغاء تثبيت الرساله*")   
...
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"*◜#ُِ︙تم الغاء تثبيت الكل*")   
...
send(msg.chat_id_,msg.id_," *◜#ُِ︙حسنآ ارسل اليه الرابط الان*")
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم تفعيل الرابط*") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم تعطيل الرابط*") 
return false end
end
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم تفعيل الصوره*") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم تعطيل الصوره*") 
return false end
end
if text == "الرابط" then 
local status_Link = database:get(bot_id.."Link_Group:status"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_," *◜#ُِ الرابط معطل*") 
return false  
end
...
linkgp = ' *◜#ُِ لا يوجد رابط ارسل ضع رابط*'
end  
...
send(msg.chat_id_,msg.id_," *◜#ُِ︙تم مسح الرابط*")   
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙ارسل لي الصوره*') 
return false
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم ازالة صورة الكروب*') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙ارسل الان الوصف*')
end
return false  
end
...
t  = ' *◜#ُِ︙ارسل لي الترحيب الان*'
tt = '\n*◜#ُِ︙تستطيع اضافة مايلي !*\n*◜#ُِ︙دالة عرض الاسم »*{`name`}\n*◜#ُِ︙دالة عرض المعرف »*{`user`}'
...
GetWelcome = ' *◜#ُِ︙لم يتم تعيين ترحيب للكروب*'
end 
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم تفعيل ترحيب الكروب*') 
return false  
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم تعطيل ترحيب الكروب*') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم ازالة ترحيب الكروب*') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then   
send(msg.chat_id_, msg.id_," *◜#ُِ︙ارسل الكلمه لمنعها*")  
...
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *◜#ُِ︙ارسل التحذير عند ارسال الكلمه*")  
...
if test == "repp" then  
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم منع الكلمه مع التحذير*")  
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙ارسل الكلمه الان*")  
database:set(bot_id.."RAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."RAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم الغاء منعها*")  
database:del(bot_id.."RAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم مسح قائمه المنع*")  
end
...
send(msg.chat_id_,msg.id_,' *◜#ُِ︙تم الغاء حفظ كليشة المطور*')
return false
end
database:set(bot_id..'TEXT_SUDO',text)
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' *◜#ُِ︙تم حفظ كليشة المطور*')
return false
end
------------------------------------------------------------------------ امـيـر الـدلـيـم
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙تم ازالة كليشة الايدي*')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم الغاء تعين الايدي*") 
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم تعين الايدي*')
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " *◜#ُِ︙لا توجد بوتات في الكروب*")
else
local t = ' *◜#ُِ︙عدد البوتات هنا >> {'..c..'}*\n*◜#ُِ︙عدد البوتات التي هي ادمن >> {'..x..'}*\n*◜#ُِ︙تم طرد >> {'..(c - x)..'} من البوتات*'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = '\n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n*◜#ُِ︙عدد البوتات التي هنا >> {'..n..'} بوت*\n'
local f = '*◜#ُِ︙عدد البوتات التي هي ادمن >> {'..t..'}*\n*◜#ُِ︙ملاحضه علامة ال (✯) تعني ان البوت ادمن* \n'
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, " *◜#ُِ︙تم الغاء حفظ القوانين*") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم حفظ قوانين الكروب*") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_," *◜#ُِ︙ارسل لي القوانين الان*")  
end
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم ازالة قوانين الكروب*")  
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙لا توجد قوانين*")   
end
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم طرد المحذوفين*')
end,nil)
end
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,' *◜#ُِ︙لا توجد صلاحيات مضافه*')
return false
end
t = "\n *◜#ُِ︙قائمة الصلاحيات المضافه* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_, " *◜#ُِ︙ارسل نوع الرتبه* \n*◜#ُِ︙{عـضـو -- ممـيـز -- ادمـن -- مـديـر}*") 
end
...
send(msg.chat_id_, msg.id_, " *◜#ُِ︙تم مسح الصلاحيه* \n") 
end
...
if text == 'مدير' then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_" *◜#ُِ︙تستطيع اضافه صلاحيات {ادمن - مميز - عضو}* \n*◜#ُِ︙ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_," *◜#ُِ︙تستطيع اضافه صلاحيات {مميز - عضو}* \n*◜#ُِ︙ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_," *◜#ُِ︙ تستطيع اضافه صلاحيات {عضو}* \n*◜#ُِ︙ارسل الصلاحيه مجددا*\n") 
return false
end
end
...
send(msg.chat_id_, msg.id_, " *◜#ُِ︙تـم اضـافـه الامـر*") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *◜#ُِ︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'KKKBK')..')'..'\n*◜#ُِ︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم مسح رسائلك*'  )  
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙عدد رسائلك » { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}*' ) 
end 
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'*◜#ُِ︙تستطيع التنظيف 1000 رساله كحد اقصى*') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,'*◜#ُِ︙تم حذف {'..num..'}*')  
...
send(msg.chat_id_, msg.id_,"*تم تنظيف الميديا ◜#ُِ*")
end
...
send(msg.chat_id_, msg.id_,'*◜#ُِ︙تم تنظيف جميع الرسائل المعدله*')
end
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *◜#ُِ︙ارسل لي الاسم الان* ")  
end
return false
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙الاذاعه معطله من قبل المطور الاساسي*')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," *◜#ُِ︙ليست لدي صلاحية تغير اسم الكروب*")  
else
send(msg.chat_id_,msg.id_,' *◜#ُِ︙تم تغيير اسم الكروب الى* {['..Name..']}')  
end
end,nil) 
end
...
function start_function(extra, result, success)
if RANSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_," *◜#ُِ︙لا تستطيع تنزيل مطور السورس او الاساسي*")
return false 
end
if Can_or_NotCan(result.sender_user_id_,msg.chat_id_) ~= false then
send(msg.chat_id_, msg.id_,"\n *◜#ُِ تم تنزيل الشخص من جميع الرتب *")
else
send(msg.chat_id_, msg.id_,"\n *◜#ُِ︙ عذرا العضو لايملك رتبه* \n")
end
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم مسح ردود المطور*")
end

if text == ("ردود المطور") and DevRANW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ◜#ُِ︙قائمة ردود المطور \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم حفظ الرد*')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' *◜#ُِ︙ارسل الرد الذي تريد اضافته*')
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم ازالة الرد العام*')
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙ارسل الكلمه تريد اضافتها*')
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙ارسل الكلمه تريد حذفها*')
...
send(msg.chat_id_, msg.id_,"*◜#ُِ︙تم حذف الرد من ردود المتعدده*")
...
send(msg.chat_id_, msg.id_,"*◜#ُِ︙تم حذف ردود المتعدده*")
end
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم مسح ردود المدير*")
end

if text == ("ردود المدير") and Manager(msg) then
local list = database:smembers(bot_id..'List:Manager'..msg.chat_id_..'')
text = " ◜#ُِ︙قائمه ردود المدير \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم ازالة الرد* ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_) 
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,"*◜#ُِ︙ارسل الكلمه التي تريد اضافتها*")
...
send(msg.chat_id_, msg.id_,"*◜#ُِ︙ارسل الكلمه التي تريد حذفها*")
database:set(bot_id.."Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '*◜#ُِ︙الان ارسل الرد الذي تريد اضافته* \n*◜#ُِ︙قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )*\n*◜#ُِ︙يمكنك اضافه الى النص :*\n◜#ُِ︙`#username` > معرف المستخدم\n◜#ُِ︙`#msgs` > عدد رسائل المستخدم\n◜#ُِ︙`#name` > اسم المستخدم\n◜#ُِ︙`#id` > ايدي المستخدم\n◜#ُِ︙`#stast` > رتبه المستخدم \n◜#ُِ︙`#edit` > عدد السحكات ')
database:set(bot_id.."Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
...
if text and text:match("^(.*)$") then
if database:get(bot_id.."Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
send(msg.chat_id_, msg.id_,"*◜#ُِ︙تم ازالة الرد من قائمه الردود*")
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_) 
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
return send(msg.chat_id_, msg.id_,"*◜#ُِ︙ارسل الرد الذي اريد اضافته*")
end
...
return send(msg.chat_id_, msg.id_,"*◜#ُِ︙ارسل الان الكلمه لحذفها*")
end
if text then  
...
send(msg.chat_id_, msg.id_,"*◜#ُِ︙تم حفظ الرد الاول ارسل الرد الثاني*")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"*◜#ُِ︙تم حفظ الرد الثاني ارسل الرد الثالث*")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,'*◜#ُِ︙تم مغادرة المجموعه*') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
Text = ' *◜#ُِ︙تم تفعيل مغادرة البوت*'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = ' *◜#ُِ︙بالتاكيد تم تفعيل مغادرة البوت*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and DevRANW(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = ' *◜#ُِ︙تم تعطيل مغادرة البوت*'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = ' *◜#ُِ︙بالتاكيد تم تعطيل مغادرة البوت*'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n *◜#ُِ︙تم تعطيل ردود المدير*' 
else
Text = '\n *◜#ُِ︙بالتاكيد تم تعطيل ردود المدير*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *◜#ُِ︙تم تفعيل ردود المطور*' 
else
Text = '\n *◜#ُِ︙بالتاكيد تم تفعيل ردود المطور*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *◜#ُِ︙تم تعطيل ردود المطور*' 
else
Text = '\n *◜#ُِ︙بالتاكيد تم تعطيل ردود المطور*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *◜#ُِ︙تم تفعيل الايدي بالصور*' 
else
Text = '\n *◜#ُِ︙بالتاكيد تم تفعيل الايدي بالصوره*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *◜#ُِ︙تم تعطيل الايدي بالصوره*' 
else
Text = '\n *◜#ُِ︙بالتاكيد تم تعطيل الايدي بالصوره*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*◜#ُِ︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'RAN')..') '
status = '\n*◜#ُِ︙تم ضافه {'..timsh..'} كلقب له*'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙ايديه ↫ '..iduser..'*\n*◜#ُِ︙معرفه ↫* '..username..'\n*◜#ُِ︙رتبته ↫ '..rtp..'*\n*◜#ُِ︙تعديلاته ↫ '..edit..'*\n*◜#ُِ︙نقاطه ↫ '..NUMPGAME..'*\n*◜#ُِ︙جهاته ↫ '..Contact..'*\n*◜#ُِ︙رسائله ↫ '..Msguser..'*')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙المعرف غير صحيح* ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
if text == 'رتبتي' then
local rtp = Rutba(msg.sender_user_id_,msg.chat_id_)
send(msg.chat_id_, msg.id_,' *◜#ُِ︙رتبتك في البوت »* '..rtp)
end
if text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
if result.first_name_  then
first_name = ' *◜#ُِ︙اسمك الاول »* {*`'..(result.first_name_)..'`*}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' *◜#ُِ︙اسمك الثاني »* {*`'..result.last_name_..'`*}' 
else
last_name = ''
end  
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' *◜#ُِ︙ايديك »* '..msg.sender_user_id_)
end
if text == 'الرتبه' and tonumber(msg.reply_to_message_id_) > 0 then
function start_function(extra, result, success)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local iduser = result.sender_user_id_
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,'*◜#ُِ︙الايدي » ('..iduser..')*\n*◜#ُِ︙الاسم » (*'..username..')\n*◜#ُِ︙الرتبه » ('..rtp..')*\n*◜#ُِ︙نوع الكشف » بالرد*')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_, '\n*◜#ُِ︙الاسم » ('..frLsn..')\n◜#ُِ︙الايدي » '..Id..'\n◜#ُِ︙المعرف » *['..UserName_User..']*\n◜#ُِ︙الرتبة » '..Status_Gps..'\n◜#ُِ︙نوع الكشف - بالمعرف*')
end, nil)
else
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙لا يوجد حساب بهاذا المعرف*')
end
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_," *◜#ُِ︙البوت ليس ادمن* \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
local amir = ' *◜#ُِ︙عدد الادمنيه :* '..data.administrator_count_..
'\n\n*◜#ُِ︙عدد المطرودين :* '..data.kicked_count_..
'\n\n*◜#ُِ︙عدد الاعضاء :* '..data.member_count_..
'\n\n*◜#ُِ︙عدد رسائل الكروب :* '..(msg.id_/2097152/0.5)..
'\n\n*◜#ُِ︙ اسم الكروب :* ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_, '\n *◜#ُِ︙عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )*')
return false
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙عذرا لا استطيع طرد ادمنية الكروب*') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم طردك من الكروب*') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم تعطيل امر اطردني*') 
end
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙المعرف غلط* ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,' *◜#ُِ︙لا استطيع اصيح معرف قنوات*') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' *◜#ُِ︙لا استطيع اصيح معرف بوتات*') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'*◜#ُِ︙لا اسطيع صيح معرفات الكروبات*') 
return false  
end
if result.id_ then
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تعال حبي يصيحونك بل كروب ['..username..']*') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم تعطيل امر صيح*') 
end
return false
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙انت منشئ الكروب*') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' *◜#ُِ︙الشخص الذي قام باضافتك هو »* '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' *◜#ُِ︙انت دخلت عبر الرابط لتلح*') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم تعطيل امر منو ضافني*') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = ' *◜#ُِ︙تم تفعيل امر منو ضافني*'
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' *◜#ُِ︙بالتاكيد تم تفعيل امر منو ضافني*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *◜#ُِ︙تم تعطيل امر منو ضافني*'
else
Text = '\n *◜#ُِ︙بالتاكيد تم تعطيل امر منو ضافني*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' *◜#ُِ︙تم تفعيل امر صيح*'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' *◜#ُِ︙بالتاكيد تم تفعيل امر صيح*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n *◜#ُِ︙تم تنزيل الكل من الرتب الاتيه* \n*◜#ُِ︙المميزين ، الادمنيه ، المدراء ، المنشئين* \n')
end
...
Text = '\n *◜#ُِ︙بالتاكيد تم تعطيل امر صيح*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = ' *◜#ُِ︙تم تفعيل امر اطردني*'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' *◜#ُِ︙بالتاكيد تم تفعيل امر اطردني*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *◜#ُِ︙تم تعطيل امر اطردني*'
else
Text = '\n *◜#ُِ︙بالتاكيد تم تعطيل امر اطردني*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," *◜#ُِ︙الصوره معطله*") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," ◜#ُِ︙عدد صورك ↫ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
...
send(msg.chat_id_, msg.id_,'*◜#ُِ︙تم تغير الايدي ارسل ايدي لرؤيته*')
end
...
local rtpg = rtpa
local amira = {
" ◜#ُِ︙اروح فـدوه للـحلوين",
" ◜#ُِ︙فديت الصاك محح",
" ◜#ُِ︙فـدشـي عمـي",
" ◜#ُِ︙دغـيرهـا شبـي هـاذ",
" ◜#ُِ︙شهل الگيمر ",
" ◜#ُِ︙شهل الصوره تخمبش ",
" ◜#ُِ︙فديت الحلو ",
" ◜#ُِ︙بـبكن حـلك ",
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, amir.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n◜#ُِ︙ايديك ↫ '..msg.sender_user_id_..'\n◜#ُِ︙معرفك ↫ '..username..'\n◜#ُِ︙رتبتك ↫ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n◜#ُِ︙موقعك ↫ '..rtpa..'\n◜#ُِ︙تفاعلك ↫ '..Total_Msg(Msguser)..'\n◜#ُِ︙رسائلك ↫ '..Msguser..'\n◜#ُِ︙نسبه تفاعلك ↫ '..string.sub(nspatfa, 1,5)..' %\n◜#ُِ︙السحكات ↫ '..edit..'\n◜#ُِ︙نقاطك ↫ '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n◜#ُِ︙ايديك ↫ '..msg.sender_user_id_..'\n◜#ُِ︙معرفك ↫ '..username..'\n◜#ُِ︙رتبتك ↫ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n◜#ُِ︙موقعك ↫ '..rtpa..'\n◜#ُِ︙تفاعلك ↫ '..Total_Msg(Msguser)..'\n◜#ُِ︙رسائلك ↫ '..Msguser..'\n◜#ُِ︙نسبه  تفاعلك ↫ '..string.sub(nspatfa, 1,5)..' %\n◜#ُِ︙السحكات ↫ '..edit..'\n◜#ُِ︙نقاطك ↫ '..NUMPGAME..']\n')
else
send(msg.chat_id_, msg.id_, '\n◜#ُِ︙الصوره ↫ ليس لديك صور في حسابك'..'[\n◜#ُِ︙ايديك ↫ '..msg.sender_user_id_..'\n◜#ُِ︙معرفك ↫ '..username..'\n◜#ُِ︙رتبتك ↫ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n◜#ُِ︙موقعك ↫ '..rtpa..'\n◜#ُِ︙تفاعلك ↫ '..Total_Msg(Msguser)..'\n◜#ُِ︙رسائلك ↫ '..Msguser..'\n◜#ُِ︙نسبه تفاعلك ↫ '..string.sub(nspatfa, 1,5)..' %\n◜#ُِ︙السحكات ↫ '..edit..'\n◜#ُِ︙نقاطك ↫ '..NUMPGAME..']\n')
end 
end
end
else
...
if Num == 0 then 
Text = ' *◜#ُِ︙ ليس لديك سحكات*'
else
Text = ' *◜#ُِ︙عدد سحكاتك » { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "مسح سحكاتي" or text == "حذف سحكاتي" then  
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم مسح سحكاتك*'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم مسح جهاتك*'  )  
...
if Num == 0 then 
Text = ' *◜#ُِ︙لم تقم بأضافه احد*'
else
Text = ' *◜#ُِ︙عدد جهاتك » { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
-- vardump(data) 
RANdx(msg.chat_id_, msg.id_, ' *◜#ُِ︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*◜#ُِ︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*◜#ُِ︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*◜#ُِ︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم اضافة له {"..numadded..'} من الرسائل*')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,  1, "*◜#ُِ︙تم اضافة له* {"..numadded..'} من النقود', 1 , 'md')  
end
------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙ارسل لي عدد الرسائل الان*') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙ارسل لي عدد النقاط التي تريد اضافتها*') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم اضافة له {"..Num..'} من النقاط*')  
end
...
if Num == 0 then 
Text = ' *◜#ُِ︙لم تلعب اي لعبه للحصول على نقاط*'
else
Text = ' *◜#ُِ︙عدد نقاطك التي ربحتها هيه » { '..Num..' } نقاط*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n* ◜#ُِ︙لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,' *◜#ُِ︙ليس لديك نقاط في الالعاب*\n*◜#ُِ︙اذا كنت تريد ربح نقاط \n*◜#ُِ︙ارسل الالعاب وابدأ اللعب !* ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n ◜#ُِ︙ليس لديك نقاط في هذه لعبه \n ◜#ُِ︙لزيادة نقاطك في اللعبه \n ◜#ُِ︙ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,' *◜#ُِ︙تم خصم » { '..NUMPY..' } من نقاطك* \n*◜#ُِ︙وتم اضافة » { '..(NUMPY * 50)..' } رساله الى رسالك*')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\n *◜#ُِ︙اهلا عزيزي البوت هنا ادمن*'..'\n*◜#ُِ︙وصلاحياته هي ↓* \n*ٴ•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*'..'\n*◜#ُِ︙تغير معلومات الكروب ↞ ❴ '..info..' ❵'..'*\n*◜#ُِ︙حذف الرسائل ↞ ❴ '..delete..' ❵'..'*\n*◜#ُِ︙حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'*\n*◜#ُِ︙دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'*\n*◜#ُِ︙تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'*\n*◜#ُِ︙اضافة مشرفين جدد ↞ ❴ '..promote..' ❵*')   
end
end
end
...
send(msg.chat_id_, msg.id_," *◜#ُِ︙تم تغير رد المطور الى »* "..Teext)
end
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,' *◜#ُِ︙هاذا الامر خاص بالادمنيه*\n*◜#ُِ︙ارسل {م10} لعرض اوامر الاعضاء*')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
Text = [[
*◜#ُِاهلا انتツفي اوامر البوت◜#ُِ*
ٴ*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*ٴ
*◜#ُِم1 ◂ اوامر الحمايه*
*◜#ُِم2 ◂ اوامر تعطيل ~ تفعيل*
*◜#ُِم3 ◂ اوامر ضع ~ اضف*
*◜#ُِم4 ◂ اوامر مسح ~ حذف*
*◜#ُِم5 ◂ اوامر تنزيل+رفع+التغير*
*◜#ُِم6 ◂ اوامر الكروب*
*◜#ُِم7 ◂ اوامر التحشيش*
*◜#ُِم8 ◂ اوامر مطور البوت*
*◜#ُِم9 ◂ اوامر مطور الاساسي* 
*◜#ُِم10 ◂ اوامر الاعضاء*
ٴ*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*ٴ
...
send(msg.chat_id_, msg.id_, t..'ٴ◜#ُِ∫ٴ*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*ٴ◜#ُِ∫○ٴ\n◜#ُِ︙[ٌ~ 𝙎ٌ𝙊ٌِّ𝙐𝙍ٌٍ𝘾𝙀 ُ𝙍 𝘼 𝙉 .](t.me/KKKBK) ')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '*◜#ُِ︙تم تعطيل الابراج*')
database:set(bot_id.." amir:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'*◜#ُِ︙تم تفعيل الابراج*')
...
send(msg.chat_id_, msg.id_, '*◜#ُِ︙تم تعطيل حساب العمر*')
...
send(msg.chat_id_, msg.id_,'*◜#ُِ︙تم تفعيل حساب العمر*')
...
File:write(t)
File:close()
sendDocument(SUDO, msg.id_,0, 1, nil, './'..bot_id..'.json', '*◜#ُِ︙عدد مجموعات التي في البوت* { '..#list..'}')
...
local Text ='*◜#ُِ︙تم اختيار المقطع الصوتي لك*'
keyboard = {} 
keyboard.inline_keyboard = {
...
t =[[
*رابط الحذف في جميع مواقع التواصل ◜#ُِ
فكر قبل لا تتسرع وتروح*
ٴ*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*ٴ
 *◜#ُِ رابط حذف*  [Telegram](https://my.telegram.org/auth?to=delete) ܁
 *◜#ُِ رابط حذف* [instagram](https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/) ܁
 *◜#ُِ رابط حذف* [Facebook](https://www.facebook.com/help/deleteaccount) ܁
 *◜#ُِ رابط حذف* [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
SendText(msg.chat_id_,msg.id_,"*◜#ُِ︙المعرف غير صحيح \n*")   
return false  end   
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙تم حذف الامر*')  
else
send(msg.chat_id_, msg.id_,' *◜#ُِ︙لا يوجد امر بهاذا الاسم*')  
end
...
send(msg.chat_id_, msg.id_, ' *◜#ُِ︙تم تعطيل اوامر التحشيش*')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التحشيش") then 
send(msg.chat_id_, msg.id_, '  *◜#ُِ︙تم تفعيل اوامر التحشيش*')
...
send(msg.chat_id_,0,''..t..'\n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n*◜#ُِ︙تم التعديل على الميديا*\n*◜#ُِ︙الشخص الي قام بالتعديل*\n*◜#ُِ︙ايدي الشخص ◂ '..result.sender_user_id_..'*\n*◜#ُِ︙معرف الشخص»{ '..users..' }*') 
end,nil)
...
if RAN1_Msg then
send(msg.chat_id_, msg.id_," ◜#ُِ︙"..RAN1_Msg)
