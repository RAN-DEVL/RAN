...
local NameUser = "*𖡺︙بواسطه »* ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "*𖡺︙اسم المستخدم »* ["..data.first_name_.."](T.me/"..UserName..")"
if status == "reply" then
send(msg.chat_id_, msg.id_,NameUserr.."\n"..text)
return false
end
else
send(msg.chat_id_, msg.id_,"𖡺︙الحساب محذوف يرجى استخدام الامر بصوره صحيحه")
end
end,nil)   
end 
...
send(chat,msg.id_,"* 𖡺︙ملف نسخه ليس لهاذا البوت*")
return false 
end  
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_," *𖡺︙جاري ...*\n*𖡺︙رفع الملف الان*")
else
send(chat,msg.id_,"* 𖡺︙عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")
end  
...
send(chat,msg.id_,"\n *𖡺︙تم رفع الملف بنجاح وتفعيل الكروبات*\n*𖡺︙ورفع {الامنشئين الاساسين ; والمنشئين ; *والمدراء; والادمنيه} بنجاح")
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\n *𖡺︙العضــو » '..Name..'*\n*𖡺︙قام بالتكرار هنا وتم طرده* '  
...
if text == "الغاء" or text == "الغاء 𖡺" then   
send(msg.chat_id_, msg.id_," 𖡺︙تم الغاء الاذاعه")
...
send(msg.chat_id_, msg.id_," 𖡺︙تمت الاذاعه الى *~ "..#list.." ~* كروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
if DevRANW(msg) then
local bl = ' *𖡺︙اهلا عزيزي آلمـطـور*\n*𖡺︙آنت آلمـطـور آلآسـآسـي للبوت*\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n*𖡺︙تسـتطـيع‌‏ آلتحگم باوامر البوت*\n*𖡺︙من خلاال الكيبورت خاص بك*\n*𖡺︙قناة سورس البوت *[اضغط هنا](t.me/KKKBK)'
local keyboard = {
{'الاحصائيات 𖡺','قناه تحديثات البوت 𖡺'},
{'تعطيل التواصل 𖡺','تفعيل التواصل 𖡺'},
{'ضع اسم للبوت 𖡺','المطورين 𖡺','قائمه العام 𖡺'},
{'الثانويين 𖡺','مسح الثانويين 𖡺'},
{'المشتركين 𖡺','الكروبات 𖡺'},
{'ضع كليشه ستارت 𖡺','حذف كليشه ستارت 𖡺'},
{'اذاعه 𖡺','اذاعه خاص 𖡺'},
{'اذاعه بالتثبيت 𖡺','قائمه الكتم العام 𖡺'},
{'تغير رساله الاشتراك','حذف رساله الاشتراك 𖡺','تغير الاشتراك'},
{'اذاعه بالتوجيه 𖡺','اذاعه بالتوجيه خاص 𖡺'},
{'تفعيل الاشتراك الاجباري 𖡺','تعطيل الاشتراك الاجباري 𖡺'},
{'الاشتراك الاجباري 𖡺','وضع قناة الاشتراك 𖡺'},
{'تفعيل البوت الخدمي 𖡺','تعطيل البوت الخدمي 𖡺'},
{'تنظيف الكروبات 𖡺','تنظيف المشتركين 𖡺'},
{'تفعيل النسخه التلقائيه 𖡺','تعطيل النسخه التلقائيه 𖡺'},
{'تغيير المطور الاساسي 𖡺'}, 
{'جلب نسخه الاحتياطيه 𖡺'},
{'تحديث السورس 𖡺','الاصدار 𖡺'},
{'معلومات السيرفر 𖡺'},
{'الغاء 𖡺'},
}
...
SourceRANr = '*𖡺︙اهلا عزيزي*\n*𖡺︙انا بوت اسمي '..Namot..'*\n*𖡺︙اختصاصي حمايه الكروبات*\n*𖡺︙من تكرار والسبام والتوجيه والخ…*\n*𖡺︙لتفعيلي اتبع الاخطوات…↓*\n*𖡺︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n𖡺︙[قناة سورس البوت](http://t.me/KKKBK)'
end
...
send(msg.sender_user_id_, msg.id_,' *𖡺︙تم ارسال رسالتك*\n*𖡺︙سيتم رد في اقرب وقت*')
...
local Text = ' *𖡺︙المستخدم » '..Name..'*\n*𖡺︙تم حظره من التواصل*'
...
if text == 'تفعيل النسخه التلقائيه 𖡺' and SudoBot(msg) then  
send(msg.chat_id_, msg.id_,"*𖡺︙تم تفعيل النسخه الاحتياطيه التلقائيه*") 
database:del(bot_id.."AutoFile")
end
if text == 'تعطيل النسخه التلقائيه 𖡺' and SudoBot(msg) then  
send(msg.chat_id_, msg.id_,"*𖡺︙تم تعطيل النسخه الاحتياطيه التلقائيه*") 
database:set(bot_id.."AutoFile",true) 
end
if text == 'مسح الثانويين 𖡺' and SudoBot(msg) then  
database:del(bot_id.."DEV:Sudo:T")
send(msg.chat_id_, msg.id_, "\n*𖡺︙تم مسح قائمة المطورين الثانويين* ")
end
if text == 'الثانويين 𖡺' and SudoBot(msg) then
local list = database:smembers(bot_id.."DEV:Sudo:T")
t = "\n*𖡺︙قائمة مطورين الثانويين للبوت* \n *•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•* \n"
for k,v in pairs(list) do
...
if #list == 0 then
t = "*𖡺︙لا يوجد مطورين ثانويين*"
end
send(msg.chat_id_, msg.id_, t)
end
if text == 'تفعيل التواصل 𖡺' and DevRANW(msg) then  
if database:get(bot_id..'Tuasl:Bots') then
database:del(bot_id..'Tuasl:Bots') 
Text = '\n *𖡺︙تم تفعيل التواصل* ' 
else
Text = '\n *𖡺︙بالتاكيد تم تفعيل التواصل* '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل التواصل 𖡺' and DevRANW(msg) then  
if not database:get(bot_id..'Tuasl:Bots') then
database:set(bot_id..'Tuasl:Bots',true) 
Text = '\n *𖡺︙تم تعطيل التواصل*' 
else
Text = '\n *𖡺︙بالتاكيد تم تعطيل التواصل*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل البوت الخدمي 𖡺' and DevRANW(msg) then  
if database:get(bot_id..'Free:Bots') then
database:del(bot_id..'Free:Bots') 
Text = '\n *𖡺︙تم تفعيل البوت الخدمي* ' 
else
Text = '\n *𖡺︙بالتاكيد تم تفعيل البوت الخدمي* '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل البوت الخدمي 𖡺' and DevRANW(msg) then  
if not database:get(bot_id..'Free:Bots') then
database:set(bot_id..'Free:Bots',true) 
Text = '\n *𖡺︙تم تعطيل البوت الخدمي*' 
else
Text = '\n *𖡺︙بالتاكيد تم تعطيل البوت الخدمي*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاء 𖡺' then   
send(msg.chat_id_, msg.id_,' *𖡺︙الغاء حفظ كليشه ستارت*')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,' *𖡺︙تم حفظ كليشه ستارت*')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'ضع كليشه ستارت 𖡺' and DevRANW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *𖡺︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت 𖡺' and DevRANW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *𖡺︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر 𖡺' and DevRANW(msg) then 
...
send(msg.chat_id_,msg.id_, "*𖡺︙تم تغيير المطور الاساسي بنجاح*")
...
send(msg.chat_id_,msg.id_, "*𖡺︙عذرا صاحب الايدي لا يمتلك معرف ارسل ايدي اخر*")
end
end,nil)
end
end
if text =='تغيير المطور الاساسي 𖡺' and SudoBot(msg) then
send(msg.chat_id_, msg.id_,'*𖡺︙ ارسل ايدي المطور الاساسي الجديد*')
database:set(bot_id..'Ed:DevBots',true) 
end
if text =='تغيير المطور الاساسي 𖡺' and not SudoBot(msg) then
send(msg.chat_id_, msg.id_,'*𖡺︙لا يمكنك تغيير المطور الاساسي*')
end
if text == 'تحديث السورس 𖡺' and DevRANW(msg) then 
os.execute('rm -rf RAN.lua')
os.execute('wget https://raw.githubusercontent.com/RAN-DEVL/RAN/main/RAN.lua')
send(msg.chat_id_, msg.id_,' *𖡺︙تم تحديث السورس* \n*𖡺︙لديك اخر اصدار لسورس ران*\n*𖡺︙الاصدار » { 2.8v}*')
dofile('RAN.lua')  
end
if text == 'الاصدار 𖡺' and DevRANW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *𖡺︙اصدار سورس ران* \n*𖡺︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت 𖡺' and DevRANW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𖡺︙[تحديثات البوت](t.me/GGGMG) \n𖡺︙[قناه السورس](t.me/KKKBK)')
end
if text == "ضع اسم للبوت 𖡺" and DevRANW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *𖡺︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات 𖡺' and DevRANW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' الاحصائيات 𖡺 \n'..' *𖡺︙عدد الكروبات » {'..Groups..'}'..'*\n *𖡺︙عدد المشتركين » {'..Users..'}*'
send(msg.chat_id_, msg.id_,Text) 
return false
end
if text == 'المشتركين 𖡺' and DevRANW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *𖡺︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات 𖡺' and DevRANW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *𖡺︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين 𖡺") and DevRANW(msg) then
...
if text == ("قائمه العام 𖡺") and DevRANW(msg) then
local list = database:smembers(bot_id..'GBan:User')
t = "\n *𖡺︙قائمه المحظورين عام* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = " *𖡺︙لا يوجد محظورين عام*"
end
send(msg.chat_id_, msg.id_, t)
return false
end
if text == ("قائمه الكتم العام 𖡺") and DevRANW(msg) then
local list = database:smembers(bot_id..'Gmute:User')
t = "\n *𖡺︙قائمة المكتومين عام* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = " *𖡺︙لا يوجد مكتومين عام*"
end
send(msg.chat_id_, msg.id_, t)
return false
end
if text=="اذاعه خاص 𖡺" and msg.reply_to_message_id_ == 0 and DevRANW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *𖡺︙ارسل الان اذاعتك؟* \n*𖡺︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه 𖡺" and msg.reply_to_message_id_ == 0 and DevRANW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *𖡺︙ارسل الان اذاعتك؟* \n*𖡺︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت 𖡺" and msg.reply_to_message_id_ == 0 and DevRANW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *𖡺︙ارسل الان اذاعتك؟* \n*𖡺︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه 𖡺" and msg.reply_to_message_id_ == 0  and DevRANW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *𖡺︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص 𖡺" and msg.reply_to_message_id_ == 0  and DevRANW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖡺︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه 𖡺' and DevRANW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين 𖡺" and DevRANW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'*𖡺︙لا يوجد مشتركين وهميين في البوت* \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'*𖡺︙عدد المشتركين الان » ( '..#pv..' )*\n*𖡺︙تم ازالة » ( '..sendok..' ) من المشتركين*\n*𖡺︙الان عدد المشتركين الحقيقي » ( '..ok..' ) مشترك* \n')   
end
end
end,nil)
end,nil)
...
if text == "تنظيف الكروبات 𖡺" and DevRANW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'*𖡺︙لا يوجد كروبات وهميه في البوت*\n')   
else
local RAN = (w + q)
...
RAN = '\n*𖡺︙تم ازالة »* { '..q..' } كروبات من البوت'
end
if w == 0 then
RANk = ''
else
RANk = '\n*𖡺︙تم ازالة »* {'..w..'} كروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'*𖡺︙عدد الكروبات الان » { '..#group..' }'..RANk..''..RAN..'*\n*𖡺︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
send(msg.chat_id_,msg.id_," 𖡺︙عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")
return false 
end  
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '*\n 𖡺︙العضو »* ['..result.title_..'](t.me/'..(username or 'KKKBK')..')'
status  = '\n *𖡺︙تم ترقيته مطور*'
texts = usertext..status
else
texts = ' *𖡺︙لا يوجد حساب بهاذا المعرف*'
end
...
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*𖡺︙تم ترقيته مطور*'
...
if RAN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *𖡺︙العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KKKBK')..') \n 𖡺︙'..RAN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
if text == 'الغاء' or text == 'الغاء 𖡺' then   
send(msg.chat_id_, msg.id_," *𖡺︙تم الغاء حفظ اسم البوت*")
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
database:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, " *𖡺︙تم حفظ الاسم*")
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء 𖡺' then   
send(msg.chat_id_, msg.id_," *𖡺︙تم الغاء الاذاعه للخاص*")
...
send(msg.chat_id_, msg.id_," *𖡺︙تمت الاذاعه الى >>{"..#list.."} مشترك في البوت* ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," *𖡺︙تمت الاذاعه الى >>{"..#list.."} كروب في البوت* ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," *𖡺︙تمت الاذاعه الى >>{"..#list.."} كروبات في البوت* ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_, " *𖡺︙تم الغاء الامر* ")
...
send(msg.chat_id_, msg.id_, ' *𖡺︙المعرف لا يوجد فيه قناة*')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, ' *𖡺︙عذا لا يمكنك وضع معرف حسابات في الاشتراك* ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' *𖡺︙عذا لا يمكنك وضع معرف كروب بالاشتراك* ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,' *𖡺︙البوت ادمن في القناة* \n*𖡺︙تم تفعيل الاشتراك الاجباري في* \n*𖡺︙ايدي القناة ('..data.id_..')*\n*𖡺︙معرف القناة* ([@'..data.type_.channel_.username_..'])')
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,' *𖡺︙عذرآ البوت ليس ادمن بالقناه* ')
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم تغيير رسالة الاشتراك* ')
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙عذرآ البوت لايملك صلاحيات*')
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,' *𖡺︙تم تغيير صورة الكروب*')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," *𖡺︙تم الغاء وضع الوصف*")
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
https.request('https://api.telegram.org/bot'..token..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
send(msg.chat_id_, msg.id_,' *𖡺︙تم تغيير وصف الكروب*')
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," *𖡺︙تم الغاء حفظ الترحيب*")
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,' *𖡺︙تم حفظ ترحيب الكروب*')
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_," *𖡺︙تم الغاء حفظ الرابط*")
...
send(msg.chat_id_,msg.id_," *𖡺︙تم حفظ الرابط بنجاح*")
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *𖡺︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n𖡺︙["..RAN_Msg.."] \n")
else
send(msg.chat_id_,0," *𖡺︙العضو :* {["..data.first_name_.."](T.ME/KKKBK)}\n𖡺︙["..RAN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, " *𖡺︙عذرا »* {[@"..data.username_.."]}\n*𖡺︙عذرا تم منع الملصق* \n" ) 
else
send(msg.chat_id_,0, " *𖡺︙عذرا »* {["..data.first_name_.."](T.ME/KKKBK)}\n*𖡺︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false   
...
send(msg.chat_id_, msg.id_,' 𖡺︙عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevRANW(msg) then
send(msg.chat_id_, msg.id_,' *𖡺︙عدد اعضاء الكروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو*')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' *𖡺︙بالتأكيد تم تفعيل الكروب*')
else
sendText(msg.chat_id_,'\n *𖡺︙بواسطه »* ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n*𖡺︙تم تفعيل الكروب *{'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = ' *𖡺︙تم تفعيل كروب جديده*\n'..
'\n *𖡺︙بواسطة* {'..Name..'}'..
'\n *𖡺︙ايدي الكروب* {'..IdChat..'}'..
'\n *𖡺︙اسم الكروب* {['..NameChat..']}'..
'\n *𖡺︙عدد اعضاء الكروب* *{'..NumMember..'}*'..
'\n *𖡺︙الرابط* {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' *𖡺︙بالتأكيد تم تعطيل الكروب*')
else
sendText(msg.chat_id_,'\n *𖡺︙بواسطه »* ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n*𖡺︙تم تعطيل الكروب *{'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' *𖡺︙تم تفعيل الكروب*')
else
sendText(msg.chat_id_,'\n *𖡺︙بواسطه »* ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n*𖡺︙تم تفعيل الكروب *{'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم تعيين عدد الاعضاء سيتم تفعيل الكروبات التي اعضائها اكثر من  >> {'..Num..'} عضو*')
end
...
send(msg.chat_id_, msg.id_, ' *𖡺︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevRANW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *𖡺︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك 𖡺" and DevRANW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *𖡺︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك 𖡺$") and DevRANW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *𖡺︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري 𖡺" and DevRANW(msg) then  
if database:get(bot_id..'add:ch:id') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_," *𖡺︙الاشتراك الاجباري مفعل* \n*𖡺︙على القناة »* ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_," 𖡺︙اهلا عزيزي المطور \n 𖡺︙ارسل الان معرف قناتك")
end
return false  
end
if text == "تعطيل الاشتراك الاجباري 𖡺" and DevRANW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *𖡺︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري 𖡺" and DevRANW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *𖡺︙تم تفعيل الاشتراك الاجباري* \n*𖡺︙على القناة »* ["..addchusername.."]")
else
send(msg.chat_id_, msg.id_, " *𖡺︙لا يوجد قناة في الاشتراك الاجباري* ")
end
return false  
end
if text == "تفعيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '*𖡺︙ تم تفعيل الاضافات*')
database:set(bot_id.."AL:Sre:stats","✔")
end
if text == "تعطيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '*𖡺︙ تم تعطيل الاضافات*')
database:set(bot_id.."AL:Sre:stats","❌")
end
...
send(msg.chat_id_, msg.id_, '*𖡺︙تم كتم الاسم* '..BlNe)
...
send(msg.chat_id_, msg.id_, '*𖡺︙تم الغاء كتم الاسم* '..delBn)
...
texts = "*𖡺︙تم مسح الاسماء المكتومه* "
send(msg.chat_id_, msg.id_, texts)
end
...
t = "\n*𖡺︙قائمة الاسماء المكتومه* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(All_name) do
t = t..""..k.."- (["..v.."])\n"
end
if #All_name == 0 then
t = "*𖡺︙لا يوجد اسماء مكتومه*"
end
send(msg.chat_id_, msg.id_, t)
end
end
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:Sre:stats") == "✔" then
send(msg.chat_id_, msg.id_, '*𖡺︙تم التفعيل الاسماء المكتومه*')
...
send(msg.chat_id_, msg.id_, '*𖡺︙تم تعطيل الاسماء المكتومه*')
...
send(msg.chat_id_, msg.id_,'*𖡺︙تم تعيين '..teh..' كتوحيد للمجموعه*')
...
send(msg.chat_id_, msg.id_,'*𖡺︙تم تعين  '..nump..' عدد الكتم*')
...
send(msg.chat_id_, msg.id_, '*𖡺︙تم تعطيل التوحيد*')
...
send(msg.chat_id_, msg.id_, "𖡺︙عزيزي >>["..RAN2.username_.."](https://t.me/"..(RAN2.username_ or "KKKBK")..")\n𖡺︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."RAN:teh"..msg.chat_id_).."} بجانب اسمك\n𖡺︙عدد المحاولات المتبقيه {"..(tonumber(RAN_nnn) - tonumber(RAN_nnn2)).."}")
end
end
end
end
...
send(msg.chat_id_, msg.id_, '*𖡺︙تم تفعيل تنبيه الاسماء*')
...
send(msg.chat_id_, msg.id_, '*𖡺︙تم تعطيل تنبيه الاسماء*')
...
send(msg.chat_id_, msg.id_, '*𖡺︙تم تفعيل تنبيه المعرف*')
...
send(msg.chat_id_, msg.id_, '*𖡺︙تم تعطيل تنبيه المعرف*')
...
send(msg.chat_id_, msg.id_, '*𖡺︙تم تفعيل تنبيه الصور*')
...
send(msg.chat_id_, msg.id_, '*𖡺︙تم تعطيل تنبيه الصور*')
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم ازالة جميع الاوامر المضافه*')  
end
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙ارسل الامر القديم*')  
return false
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙ارسل الامر الذي قمت بوضعه بدلا عن القديم*')  
return false
end
end
if text and database:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
database:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,' *𖡺︙ارسل الامر الجديد*')  
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم حفظ الامر*')  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *𖡺︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KKKBK')..') \n*𖡺︙تـم قفـل الدردشه* ')
end,nil)   
...
Text = ' *𖡺︙تم تفعيل نسبه الحب*'
database:del(bot_id..'Cick:lov'..msg.chat_id_)  
else
Text = ' *𖡺︙بالتاكيد تم تفعيل نسبه الحب*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *𖡺︙تم تعطيل نسبه الانوثه*'
else
Text = '\n *𖡺︙بالتاكيد تم تعطيل نسبه الانوثه*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل غنيلي' and CoSu(msg) then   
if database:get(bot_id..'sing:for:me'..msg.chat_id_) then
Text = ' *𖡺︙تم تفعيل امر غنيلي الان ارسل غنيلي*'
database:del(bot_id..'sing:for:me'..msg.chat_id_)  
else
Text = ' *𖡺︙بالتاكيد تم تفعيل امر غنيلي تستطيع ارسال غنيلي*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *𖡺︙تم تعطيل امر غنيلي*'
else
Text = '\n *𖡺︙بالتاكيد تم تعطيل امر غنيلي*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,"*𖡺︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " *𖡺︙لا تسطيع حظر البوت عام*")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " *𖡺︙لا تسطيع كتم البوت عام*")
return false 
end
...
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*𖡺︙تم الغاء (الحظر-الكتم) عام من الكروبات*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
send(msg.chat_id_, msg.id_, "\n *𖡺︙تم مسح قائمة المطورين*  ")
end
if text == ("المطورين") and DevRANW(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n *𖡺︙قائمة مطورين البوت* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if Get_info then
local TextS = "\n *𖡺︙اهلا بك في متجر ملفات ران*\n*𖡺︙ملفات السورس ↓*\n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n *𖡺︙علامة تعني { ✓ } ملف مفعل*\n *𖡺︙علامة تعني { ✘ } ملف معطل*\n *𖡺︙قناة سورس ران ↓*\n".." *𖡺︙*[اضغط هنا لدخول](t.me/KKKBK) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," *𖡺︙لا يوجد اتصال من ال api* \n") 
end
return false
end
end
...
t = " *𖡺︙بالتاكيد تم تعطيل ملف →* "..file.."\n"
end
...
send(msg.chat_id_, msg.id_," *𖡺︙عذرا الملف لايدعم سورس ران* \n") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = " *𖡺︙بالتاكيد تم تفعيل ملف →* "..file.." \n"
else
t = " *𖡺︙الملف »* "..file.."\n*𖡺︙تم تفعيل ملف* \n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/RAN-DEVL/Files_RAN/main/File_Bot/"..file)
...
send(msg.chat_id_,msg.id_," *𖡺︙تم مسح الملفات*")
return false
end
...
if #list == 0 then
t = " *𖡺︙لا يوجد احد في قائمه المالك*"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
t = "*𖡺︙المنشئين الاساسين تعالو مخرب* \n *•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•* \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = "*𖡺︙ماكو منششئين يشوفولك جاره*"
end
Reply_Status(msg,msg.sender_user_id_,"reply","*𖡺︙قام بنشر ملصق اباحيه*\n"..t)  
...
Reply_Status(msg,msg.sender_user_id_,"reply","*𖡺︙قام بنشر صوره اباحيه*\n"..t)  
DeleteMessage(msg.chat_id_,{[0] = tonumber(msg.id_),msg.id_})   
end   
end
if text == 'المنشئين الاساسين' and CoSu(msg) then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n *𖡺︙قائمة المنشئين الاساسين* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
send(msg.chat_id_, msg.id_," *𖡺︙حساب المنشئ محذوف*")
return false  
end
local UserName = (b.username_ or "KKKBK")
send(msg.chat_id_, msg.id_," 𖡺︙منشئ الكروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," *𖡺︙لا يوجد ادمنيه ليتم رفعهم*") 
else
send(msg.chat_id_, msg.id_," *𖡺︙تمت ترقيه { "..num2.." } من الادمنيه*") 
end
end,nil)   
end
...
Reply_Status(msg,result.sender_user_id_,"reply","*𖡺︙تم ترقيته مطور ثانوي في البوت*")  
end
...
Reply_Status(msg,result.id_,"reply","*𖡺︙تم ترقيته مطور ثانوي في البوت*")  
else
send(msg.chat_id_, msg.id_,"*𖡺︙لا يوجد حساب بهاذا المعرف*")
end
end
...
Reply_Status(msg,userid,"reply","*𖡺︙تم ترقيته مطور ثانوي في البوت*")  
return false 
end
if text == ("تنزيل مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
function Function_RAN(extra, result, success)
database:srem(bot_id.."DEV:Sudo:T", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","*𖡺︙تم تنزيله من المطور ثانويين*")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_RAN, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","*𖡺︙تم تنزيله من المطور ثانويين*")  
else
send(msg.chat_id_, msg.id_,"*𖡺︙لا يوجد حساب بهاذا المعرف*")
end
end
...
Reply_Status(msg,userid,"reply","*𖡺︙تم تنزيله من المطور ثانويين*")  
return false 
end
...
send(msg.chat_id_, msg.id_, ' 𖡺︙تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم تعطيل الرفع*') 
return false
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم تعطيل الطرد*') 
return false
end
function start_function(extra, result, success)
if RANSudoBot(result.sender_user_id_) then
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " *𖡺︙لا تسطيع طرد البوت* ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n *𖡺︙عذرا لا تستطيع طرد* ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' *𖡺︙ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !*') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' *𖡺︙البوت ليس ادمن يرجى ترقيتي !*') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
...
send(msg.chat_id_, msg.id_, '\n *𖡺︙عذرا لا تستطيع طرد* ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"*𖡺︙عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !*")   
...
send(msg.chat_id_, msg.id_, '\n *𖡺︙عذرا لا تستطيع طرد* ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, ' *𖡺︙تم مسح المميزين*')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n *𖡺︙قائمة مميزين الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *𖡺︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*𖡺︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *𖡺︙العضو »* '..userid..''
...
send(msg.chat_id_, msg.id_, ' *𖡺︙تم مسح جميع المطايه*')
end
if text == ("تاك للمطايه") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n *𖡺︙قائمة مطايه الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n*𖡺︙تم رفع العضو مطي في الكروب* \n*𖡺︙تعال حبي استلم العربانه*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*𖡺︙تم تنزيل العضو مطي في الكروب*\n*𖡺︙تعال حبي رجع العربانه*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n*𖡺︙تم رفع العضــو الحاته في الكروب* \n*𖡺︙تعال يحاته ممكن نتعرف*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*𖡺︙تم تنزيل العضــو الحاته من الكروب*\n*𖡺︙مشيي مو خوش حاتهه*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n*𖡺︙تم رفع العضــو الحات في الكروب* \n*𖡺︙تعال حبي الحات نطيني بوسه*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*𖡺︙تم تنزيل العضــو الحات من الكروب*\n*𖡺︙مشيي مو خوش حات*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *𖡺︙تم تنزيل جميع صخوله من الكروب*')
end
if text == ("تاك للصخوله") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n *𖡺︙قائمة صخوله الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local  statuss  = '\n*𖡺︙تم رفع المتهم صخل بالكروب*\n*𖡺︙الان اصبح صخل الكروب*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *𖡺︙تم تنزيل جميع جلاب الكروب*')
end
if text == ("تاك للجلاب") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n *𖡺︙قائمة الجلاب الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local  statuss  = '\n*𖡺︙تم رفع جلب في الكروب*\n*𖡺︙تعال حبي اطيك عضمه*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *𖡺︙تم تنزيل جميع القروده بالكروب*')
end
if text == ("تاك للقروده") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n *𖡺︙قائمة القروده الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local  statuss  = '\n*𖡺︙تم رفع قرد في الكروب*\n*𖡺︙تعال حبي استلم موزه*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local  statuss  = '\n*𖡺︙تم رفع حصان في الكروب*\n*𖡺︙تعال حبي احطلك سرج وركبك فرني فره حلوه*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *𖡺︙تم تنزيل جميع البقرات بالكروب*')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n *𖡺︙قائمة البقرات الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local  statuss  = '\n*𖡺︙تم رفع بقره في الكروب*\n*𖡺︙ها يالهايشه تع احلبك*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*𖡺︙تم تنزيل بقره من الكروب*\n*𖡺︙تعال هاك حليب مالتك*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *𖡺︙تم تنزيل جميع طليان بالكروب')
end
if text == ("تاك للطليان") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n *𖡺︙قائمة الطليان الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local  statuss  = '\n*𖡺︙تم رفع الطلي في الكروب*\n*𖡺︙طلع برا ابو البعرور الوصخ*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *𖡺︙تم تنزيل جميع زواحف*')
end
if text == ("تاك للزواحف") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n *𖡺︙قائمة الزواحف الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*𖡺︙تم تنزيل زاحف من الكروب*\n*𖡺︙هاك حبي هاذا رقم مالك*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *𖡺︙تم تنزيل جميع جريزي*')
end
if text == ("تاك للجريذيه") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n *𖡺︙قائمة الجريذيه الكروب* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local  statuss  = '\n*𖡺︙تم رفع جريذي في الكروب*\n*𖡺︙خايس ريحتك موتتنه روح سبح يع*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' *𖡺︙تم تعطيل الحظر*') 
return false
end
function start_function(extra, result, success)
if RANSudoBot(result.sender_user_id_) then
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " *𖡺︙لا تسطيع حظر البوت* ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n *𖡺︙عذرا لا تستطيع حظر* ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n *𖡺︙عذرا لا تستطيع حظر* ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," *𖡺︙عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !*")   
...
usertext = '\n *𖡺︙ المستخدم »* ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n*𖡺︙تم حظره*'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n *𖡺︙عذرا لا تستطيع حظر* ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' *𖡺︙ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !*') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, ' *𖡺︙انا لست محظورآ* \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, ' *𖡺︙تم مسح المكتومين*')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " *𖡺︙لا تسطيع كتم البوت* ")
return false 
end
if RANSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*𖡺︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
...
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n *𖡺︙عذرا لا تستطيع كتم* ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' *𖡺︙البوت ليس ادمن يرجى ترقيتي !*') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n *𖡺︙عذرا لا تستطيع كتم* ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," *𖡺︙عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !*")   
return false 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*𖡺︙تم كتم لمدة ~* { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n *𖡺︙عذرا لا تستطيع كتم* ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' *𖡺︙البوت ليس ادمن يرجى ترقيتي !*') 
return false  
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖡺︙لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n *𖡺︙عذرا لا تستطيع تقيد* ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n *𖡺︙عذرا لا تستطيع تقيد* ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*𖡺︙تم تقيده لمدة ~* { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n *𖡺︙عذرا لا تستطيع تقيد* ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙ العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*𖡺︙ الايدي »* `'..result.sender_user_id_..'`\n*𖡺︙ تم رفعه مشرف* '
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *𖡺︙ العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
status  = '\n*𖡺︙ الايدي »* '..result.sender_user_id_..'\n*𖡺︙ تم تنزيله ادمن من الكروب بكل الصلاحيات*'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
local text = 
'\n *𖡺︙اعدادات الكروب كتالي √↓*'..
'\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n*𖡺︙ علامة ال {✓} تعني معطل*'..
'\n*𖡺︙ علامة ال {✘} تعني مفعل*'..
'\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n*𖡺︙ الروابط »* { '..lock_links..
' }\n'..'*𖡺︙ المعرفات »* { '..lock_user..
' }\n'..'*𖡺︙ التاك »* { '..lock_hash..
' }\n'..'*𖡺︙ البوتات »* { '..lock_bots..
' }\n'..'*𖡺︙ التوجيه »* { '..lock_fwd..
' }\n'..'*𖡺︙ التثبيت »* { '..lock_pin..
' }\n'..'*𖡺︙ الاشعارات »* { '..lock_tagservr..
' }\n'..'*𖡺︙ الماركدون »* { '..lock_mark..
' }\n'..'*𖡺︙ التعديل »* { '..lock_edit..
' }\n'..'*𖡺︙ تعديل الميديا »* { '..lock_edit_med..
' }\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n'..'*𖡺︙ الكلايش »* { '..lock_spam..
' }\n'..'*𖡺︙ الكيبورد »* { '..lock_inlin..
' }\n'..'*𖡺︙ الاغاني »* { '..lock_vico..
' }\n'..'*𖡺︙ المتحركه »* { '..lock_gif..
' }\n'..'*𖡺︙ الملفات »* { '..lock_file..
' }\n'..'*𖡺︙ الدردشه »* { '..lock_text..
...
' }\n'..'*𖡺︙ التكرار »* { '..flood..
' }\n'..'*𖡺︙ الترحيب »* { '..welcome..
' }\n'..'*𖡺︙ عدد التكرار »* { '..NUM_MSG_MAX..
' }\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n*𖡺︙ علامة ال {✓} تعني مفعل*'..
'\n*𖡺︙ علامة ال {✘} تعني معطل*'..
'\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n'..'*𖡺︙ امر صيح »* { '..kickme..
' }\n'..'*𖡺︙ امر اطردني »* { '..sehuser..
' }\n'..'*𖡺︙ امر منو ضافني »* { '..addme..
' }\n'..'*𖡺︙ ردود المدير »* { '..rdmder..
' }\n'..'*𖡺︙ ردود المطور »* { '..rdsudo..
' }\n'..'*𖡺︙ الايدي »* { '..idgp..
' }\n'..'*𖡺︙ الايدي بالصوره »* { '..idph..
' }\n'..'*𖡺︙ الرفع »* { '..setadd..
' }\n'..'*𖡺︙ الحظر »* { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n *𖡺︙ CH » @KKKBK*\n'
send(msg.chat_id_, msg.id_,text) 
end
...
send(msg.chat_id_,msg.id_," *𖡺︙عذرآ تم قفل التثبيت*")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," *𖡺︙تم تثبيت الرساله*")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_," *𖡺︙انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله*")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_," *𖡺︙لا توجد رساله مثبته*")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," *𖡺︙ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات*")  
end
end,nil) 
end
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_," *𖡺︙عذرآ تم قفل الثبيت*")  
return false  
end
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," *𖡺︙تم الغاء تثبيت الرساله*")   
...
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"*𖡺︙تم الغاء تثبيت الكل*")   
...
send(msg.chat_id_,msg.id_," *𖡺︙حسنآ ارسل اليه الرابط الان*")
...
send(msg.chat_id_, msg.id_," *𖡺︙تم تفعيل الرابط*") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," *𖡺︙تم تعطيل الرابط*") 
return false end
end
...
send(msg.chat_id_, msg.id_," *𖡺︙تم تفعيل الصوره*") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," *𖡺︙تم تعطيل الصوره*") 
return false end
end
if text == "الرابط" then 
local status_Link = database:get(bot_id.."Link_Group:status"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_," *𖡺 الرابط معطل*") 
return false  
end
...
linkgp = ' *𖡺 لا يوجد رابط ارسل ضع رابط*'
end  
...
send(msg.chat_id_,msg.id_," *𖡺︙تم مسح الرابط*")   
...
send(msg.chat_id_, msg.id_,' *𖡺︙ارسل لي الصوره*') 
return false
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم ازالة صورة الكروب*') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙ارسل الان الوصف*')
end
return false  
end
...
t  = ' *𖡺︙ارسل لي الترحيب الان*'
tt = '\n*𖡺︙تستطيع اضافة مايلي !*\n*𖡺︙دالة عرض الاسم »*{`name`}\n*𖡺︙دالة عرض المعرف »*{`user`}'
...
GetWelcome = ' *𖡺︙لم يتم تعيين ترحيب للكروب*'
end 
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم تفعيل ترحيب الكروب*') 
return false  
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم تعطيل ترحيب الكروب*') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' *𖡺︙تم ازالة ترحيب الكروب*') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then   
send(msg.chat_id_, msg.id_," *𖡺︙ارسل الكلمه لمنعها*")  
...
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *𖡺︙ارسل التحذير عند ارسال الكلمه*")  
...
if test == "repp" then  
send(msg.chat_id_, msg.id_," *𖡺︙تم منع الكلمه مع التحذير*")  
...
send(msg.chat_id_, msg.id_," *𖡺︙ارسل الكلمه الان*")  
database:set(bot_id.."RAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."RAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_," *𖡺︙تم الغاء منعها*")  
database:del(bot_id.."RAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
send(msg.chat_id_, msg.id_," *𖡺︙تم مسح قائمه المنع*")  
end
...
send(msg.chat_id_,msg.id_,' *𖡺︙تم الغاء حفظ كليشة المطور*')
return false
end
database:set(bot_id..'TEXT_SUDO',text)
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' *𖡺︙تم حفظ كليشة المطور*')
return false
end
------------------------------------------------------------------------ امـيـر الـدلـيـم
...
send(msg.chat_id_, msg.id_, ' *𖡺︙تم ازالة كليشة الايدي*')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," *𖡺︙تم الغاء تعين الايدي*") 
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم تعين الايدي*')
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " *𖡺︙لا توجد بوتات في الكروب*")
else
local t = ' *𖡺︙عدد البوتات هنا >> {'..c..'}*\n*𖡺︙عدد البوتات التي هي ادمن >> {'..x..'}*\n*𖡺︙تم طرد >> {'..(c - x)..'} من البوتات*'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = '\n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n*𖡺︙عدد البوتات التي هنا >> {'..n..'} بوت*\n'
local f = '*𖡺︙عدد البوتات التي هي ادمن >> {'..t..'}*\n*𖡺︙ملاحضه علامة ال (✯) تعني ان البوت ادمن* \n'
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, " *𖡺︙تم الغاء حفظ القوانين*") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_," *𖡺︙تم حفظ قوانين الكروب*") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_," *𖡺︙ارسل لي القوانين الان*")  
end
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_," *𖡺︙تم ازالة قوانين الكروب*")  
...
send(msg.chat_id_, msg.id_," *𖡺︙لا توجد قوانين*")   
end
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم طرد المحذوفين*')
end,nil)
end
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,' *𖡺︙لا توجد صلاحيات مضافه*')
return false
end
t = "\n *𖡺︙قائمة الصلاحيات المضافه* \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_, " *𖡺︙ارسل نوع الرتبه* \n*𖡺︙{عـضـو -- ممـيـز -- ادمـن -- مـديـر}*") 
end
...
send(msg.chat_id_, msg.id_, " *𖡺︙تم مسح الصلاحيه* \n") 
end
...
if text == 'مدير' then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_" *𖡺︙تستطيع اضافه صلاحيات {ادمن - مميز - عضو}* \n*𖡺︙ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_," *𖡺︙تستطيع اضافه صلاحيات {مميز - عضو}* \n*𖡺︙ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_," *𖡺︙ تستطيع اضافه صلاحيات {عضو}* \n*𖡺︙ارسل الصلاحيه مجددا*\n") 
return false
end
end
...
send(msg.chat_id_, msg.id_, " *𖡺︙تـم اضـافـه الامـر*") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *𖡺︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'KKKBK')..')'..'\n*𖡺︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم مسح رسائلك*'  )  
...
send(msg.chat_id_, msg.id_,' *𖡺︙عدد رسائلك » { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}*' ) 
end 
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'*𖡺︙تستطيع التنظيف 1000 رساله كحد اقصى*') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,'*𖡺︙تم حذف {'..num..'}*')  
...
send(msg.chat_id_, msg.id_,"*تم تنظيف الميديا 𖡺*")
end
...
send(msg.chat_id_, msg.id_,'*𖡺︙تم تنظيف جميع الرسائل المعدله*')
end
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *𖡺︙ارسل لي الاسم الان* ")  
end
return false
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙الاذاعه معطله من قبل المطور الاساسي*')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," *𖡺︙ليست لدي صلاحية تغير اسم الكروب*")  
else
send(msg.chat_id_,msg.id_,' *𖡺︙تم تغيير اسم الكروب الى* {['..Name..']}')  
end
end,nil) 
end
...
function start_function(extra, result, success)
if RANSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_," *𖡺︙لا تستطيع تنزيل مطور السورس او الاساسي*")
return false 
end
if Can_or_NotCan(result.sender_user_id_,msg.chat_id_) ~= false then
send(msg.chat_id_, msg.id_,"\n *𖡺 تم تنزيل الشخص من جميع الرتب *")
else
send(msg.chat_id_, msg.id_,"\n *𖡺︙ عذرا العضو لايملك رتبه* \n")
end
...
send(msg.chat_id_, msg.id_," *𖡺︙تم مسح ردود المطور*")
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم حفظ الرد*')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' *𖡺︙ارسل الرد الذي تريد اضافته*')
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم ازالة الرد العام*')
...
send(msg.chat_id_, msg.id_,' *𖡺︙ارسل الكلمه تريد اضافتها*')
...
send(msg.chat_id_, msg.id_,' *𖡺︙ارسل الكلمه تريد حذفها*')
...
send(msg.chat_id_, msg.id_,"*𖡺︙تم حذف الرد من ردود المتعدده*")
...
send(msg.chat_id_, msg.id_,"*𖡺︙تم حذف ردود المتعدده*")
end
...
send(msg.chat_id_, msg.id_," *𖡺︙تم مسح ردود المدير*")
end

if text == ("ردود المدير") and Manager(msg) then
local list = database:smembers(bot_id..'List:Manager'..msg.chat_id_..'')
text = " 𖡺︙قائمه ردود المدير \n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم ازالة الرد* ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_) 
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,"*𖡺︙ارسل الكلمه التي تريد اضافتها*")
...
send(msg.chat_id_, msg.id_,"*𖡺︙ارسل الكلمه التي تريد حذفها*")
database:set(bot_id.."Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '*𖡺︙الان ارسل الرد الذي تريد اضافته* \n*𖡺︙قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )*\n*𖡺︙يمكنك اضافه الى النص :*\n𖡺︙`#username` > معرف المستخدم\n𖡺︙`#msgs` > عدد رسائل المستخدم\n𖡺︙`#name` > اسم المستخدم\n𖡺︙`#id` > ايدي المستخدم\n𖡺︙`#stast` > رتبه المستخدم \n𖡺︙`#edit` > عدد السحكات ')
database:set(bot_id.."Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
...
if text and text:match("^(.*)$") then
if database:get(bot_id.."Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
send(msg.chat_id_, msg.id_,"*𖡺︙تم ازالة الرد من قائمه الردود*")
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_) 
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
return send(msg.chat_id_, msg.id_,"*𖡺︙ارسل الرد الذي اريد اضافته*")
end
...
return send(msg.chat_id_, msg.id_,"*𖡺︙ارسل الان الكلمه لحذفها*")
end
if text then  
...
send(msg.chat_id_, msg.id_,"*𖡺︙تم حفظ الرد الاول ارسل الرد الثاني*")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"*𖡺︙تم حفظ الرد الثاني ارسل الرد الثالث*")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,'*𖡺︙تم مغادرة المجموعه*') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
Text = ' *𖡺︙تم تفعيل مغادرة البوت*'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = ' *𖡺︙بالتاكيد تم تفعيل مغادرة البوت*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and DevRANW(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = ' *𖡺︙تم تعطيل مغادرة البوت*'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = ' *𖡺︙بالتاكيد تم تعطيل مغادرة البوت*'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n *𖡺︙تم تعطيل ردود المدير*' 
else
Text = '\n *𖡺︙بالتاكيد تم تعطيل ردود المدير*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *𖡺︙تم تفعيل ردود المطور*' 
else
Text = '\n *𖡺︙بالتاكيد تم تفعيل ردود المطور*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *𖡺︙تم تعطيل ردود المطور*' 
else
Text = '\n *𖡺︙بالتاكيد تم تعطيل ردود المطور*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *𖡺︙تم تفعيل الايدي بالصور*' 
else
Text = '\n *𖡺︙بالتاكيد تم تفعيل الايدي بالصوره*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *𖡺︙تم تعطيل الايدي بالصوره*' 
else
Text = '\n *𖡺︙بالتاكيد تم تعطيل الايدي بالصوره*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*𖡺︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'RAN')..') '
status = '\n*𖡺︙تم ضافه {'..timsh..'} كلقب له*'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
send(msg.chat_id_, msg.id_,' *𖡺︙ايديه ↫ '..iduser..'*\n*𖡺︙معرفه ↫* '..username..'\n*𖡺︙رتبته ↫ '..rtp..'*\n*𖡺︙تعديلاته ↫ '..edit..'*\n*𖡺︙نقاطه ↫ '..NUMPGAME..'*\n*𖡺︙جهاته ↫ '..Contact..'*\n*𖡺︙رسائله ↫ '..Msguser..'*')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙المعرف غير صحيح* ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
if text == 'رتبتي' then
local rtp = Rutba(msg.sender_user_id_,msg.chat_id_)
send(msg.chat_id_, msg.id_,' *𖡺︙رتبتك في البوت »* '..rtp)
end
if text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
if result.first_name_  then
first_name = ' *𖡺︙اسمك الاول »* {*`'..(result.first_name_)..'`*}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' *𖡺︙اسمك الثاني »* {*`'..result.last_name_..'`*}' 
else
last_name = ''
end  
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' *𖡺︙ايديك »* '..msg.sender_user_id_)
end
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'KKKBK')..')'
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,'*𖡺︙الايدي » ('..iduser..')*\n*𖡺︙الاسم » (*'..username..')\n*𖡺︙الرتبه » ('..rtp..')*\n*𖡺︙نوع الكشف » بالرد*')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_," *𖡺︙البوت ليس ادمن* \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
local amir = ' *𖡺︙عدد الادمنيه :* '..data.administrator_count_..
'\n\n*𖡺︙عدد المطرودين :* '..data.kicked_count_..
'\n\n*𖡺︙عدد الاعضاء :* '..data.member_count_..
'\n\n*𖡺︙عدد رسائل الكروب :* '..(msg.id_/2097152/0.5)..
'\n\n*𖡺︙ اسم الكروب :* ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_, '\n *𖡺︙عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )*')
return false
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙عذرا لا استطيع طرد ادمنية الكروب*') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' *𖡺︙تم طردك من الكروب*') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,' *𖡺︙تم تعطيل امر اطردني*') 
end
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙المعرف غلط* ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,' *𖡺︙لا استطيع اصيح معرف قنوات*') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' *𖡺︙لا استطيع اصيح معرف بوتات*') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'*𖡺︙لا اسطيع صيح معرفات الكروبات*') 
return false  
end
if result.id_ then
send(msg.chat_id_, msg.id_,' *𖡺︙تعال حبي يصيحونك بل كروب ['..username..']*') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' *𖡺︙تم تعطيل امر صيح*') 
end
return false
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙انت منشئ الكروب*') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' *𖡺︙الشخص الذي قام باضافتك هو »* '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' *𖡺︙انت دخلت عبر الرابط لتلح*') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' *𖡺︙تم تعطيل امر منو ضافني*') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = ' *𖡺︙تم تفعيل امر منو ضافني*'
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' *𖡺︙بالتاكيد تم تفعيل امر منو ضافني*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *𖡺︙تم تعطيل امر منو ضافني*'
else
Text = '\n *𖡺︙بالتاكيد تم تعطيل امر منو ضافني*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' *𖡺︙تم تفعيل امر صيح*'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' *𖡺︙بالتاكيد تم تفعيل امر صيح*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n *𖡺︙تم تنزيل الكل من الرتب الاتيه* \n*𖡺︙المميزين ، الادمنيه ، المدراء ، المنشئين* \n')
end
...
Text = '\n *𖡺︙بالتاكيد تم تعطيل امر صيح*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = ' *𖡺︙تم تفعيل امر اطردني*'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' *𖡺︙بالتاكيد تم تفعيل امر اطردني*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *𖡺︙تم تعطيل امر اطردني*'
else
Text = '\n *𖡺︙بالتاكيد تم تعطيل امر اطردني*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," *𖡺︙الصوره معطله*") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 𖡺︙عدد صورك ↫ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
...
send(msg.chat_id_, msg.id_,'*𖡺︙تم تغير الايدي ارسل ايدي لرؤيته*')
end
...
local rtpg = rtpa
local amira = {
" 𖡺︙اروح فـدوه للـحلوين",
" 𖡺︙فديت الصاك محح",
" 𖡺︙فـدشـي عمـي",
" 𖡺︙دغـيرهـا شبـي هـاذ",
" 𖡺︙شهل الگيمر ",
" 𖡺︙شهل الصوره تخمبش ",
" 𖡺︙فديت الحلو ",
" 𖡺︙بـبكن حـلك ",
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, amir.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n𖡺︙ايديك ↫ '..msg.sender_user_id_..'\n𖡺︙معرفك ↫ '..username..'\n𖡺︙رتبتك ↫ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n𖡺︙موقعك ↫ '..rtpa..'\n𖡺︙تفاعلك ↫ '..Total_Msg(Msguser)..'\n𖡺︙رسائلك ↫ '..Msguser..'\n𖡺︙نسبه تفاعلك ↫ '..string.sub(nspatfa, 1,5)..' %\n𖡺︙السحكات ↫ '..edit..'\n𖡺︙نقاطك ↫ '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n𖡺︙ايديك ↫ '..msg.sender_user_id_..'\n𖡺︙معرفك ↫ '..username..'\n𖡺︙رتبتك ↫ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n𖡺︙موقعك ↫ '..rtpa..'\n𖡺︙تفاعلك ↫ '..Total_Msg(Msguser)..'\n𖡺︙رسائلك ↫ '..Msguser..'\n𖡺︙نسبه  تفاعلك ↫ '..string.sub(nspatfa, 1,5)..' %\n𖡺︙السحكات ↫ '..edit..'\n𖡺︙نقاطك ↫ '..NUMPGAME..']\n')
else
send(msg.chat_id_, msg.id_, '\n𖡺︙الصوره ↫ ليس لديك صور في حسابك'..'[\n𖡺︙ايديك ↫ '..msg.sender_user_id_..'\n𖡺︙معرفك ↫ '..username..'\n𖡺︙رتبتك ↫ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n𖡺︙موقعك ↫ '..rtpa..'\n𖡺︙تفاعلك ↫ '..Total_Msg(Msguser)..'\n𖡺︙رسائلك ↫ '..Msguser..'\n𖡺︙نسبه تفاعلك ↫ '..string.sub(nspatfa, 1,5)..' %\n𖡺︙السحكات ↫ '..edit..'\n𖡺︙نقاطك ↫ '..NUMPGAME..']\n')
end 
end
end
else
...
if Num == 0 then 
Text = ' *𖡺︙ ليس لديك سحكات*'
else
Text = ' *𖡺︙عدد سحكاتك » { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "مسح سحكاتي" or text == "حذف سحكاتي" then  
send(msg.chat_id_, msg.id_,' *𖡺︙تم مسح سحكاتك*'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
send(msg.chat_id_, msg.id_,' *𖡺︙تم مسح جهاتك*'  )  
...
if Num == 0 then 
Text = ' *𖡺︙لم تقم بأضافه احد*'
else
Text = ' *𖡺︙عدد جهاتك » { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
-- vardump(data) 
RANdx(msg.chat_id_, msg.id_, ' *𖡺︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*𖡺︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*𖡺︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*𖡺︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_," *𖡺︙تم اضافة له {"..numadded..'} من الرسائل*')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,  1, "*𖡺︙تم اضافة له* {"..numadded..'} من النقود', 1 , 'md')  
end
------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' *𖡺︙ارسل لي عدد الرسائل الان*') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' *𖡺︙ارسل لي عدد النقاط التي تريد اضافتها*') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_," *𖡺︙تم اضافة له {"..Num..'} من النقاط*')  
end
...
if Num == 0 then 
Text = ' *𖡺︙لم تلعب اي لعبه للحصول على نقاط*'
else
Text = ' *𖡺︙عدد نقاطك التي ربحتها هيه » { '..Num..' } نقاط*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n* 𖡺︙لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,' *𖡺︙ليس لديك نقاط في الالعاب*\n*𖡺︙اذا كنت تريد ربح نقاط \n*𖡺︙ارسل الالعاب وابدأ اللعب !* ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n 𖡺︙ليس لديك نقاط في هذه لعبه \n 𖡺︙لزيادة نقاطك في اللعبه \n 𖡺︙ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,' *𖡺︙تم خصم » { '..NUMPY..' } من نقاطك* \n*𖡺︙وتم اضافة » { '..(NUMPY * 50)..' } رساله الى رسالك*')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\n *𖡺︙اهلا عزيزي البوت هنا ادمن*'..'\n*𖡺︙وصلاحياته هي ↓* \n*ٴ•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*'..'\n*𖡺︙تغير معلومات الكروب ↞ ❴ '..info..' ❵'..'*\n*𖡺︙حذف الرسائل ↞ ❴ '..delete..' ❵'..'*\n*𖡺︙حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'*\n*𖡺︙دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'*\n*𖡺︙تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'*\n*𖡺︙اضافة مشرفين جدد ↞ ❴ '..promote..' ❵*')   
end
end
end
...
send(msg.chat_id_, msg.id_," *𖡺︙تم تغير رد المطور الى »* "..Teext)
end
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,' *𖡺︙هاذا الامر خاص بالادمنيه*\n*𖡺︙ارسل {م10} لعرض اوامر الاعضاء*')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
Text = [[
*𖡺اهلا انتツفي اوامر البوت𖡺*
ٴ*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*ٴ
*𖡺م1 ◂ اوامر الحمايه*
*𖡺م2 ◂ اوامر تعطيل ~ تفعيل*
*𖡺م3 ◂ اوامر ضع ~ اضف*
*𖡺م4 ◂ اوامر مسح ~ حذف*
*𖡺م5 ◂ اوامر تنزيل+رفع+التغير*
*𖡺م6 ◂ اوامر الكروب*
*𖡺م7 ◂ اوامر التحشيش*
*𖡺م8 ◂ اوامر مطور البوت*
*𖡺م9 ◂ اوامر مطور الاساسي* 
*𖡺م10 ◂ اوامر الاعضاء*
ٴ*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*ٴ
...
send(msg.chat_id_, msg.id_, t..'ٴ𖡺∫ٴ*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*ٴ𖡺∫○ٴ\n𖡺︙[ٌ~ 𝙎ٌ𝙊ٌِّ𝙐𝙍ٌٍ𝘾𝙀 ُ𝙍 𝘼 𝙉 .](t.me/KKKBK) ')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '*𖡺︙تم تعطيل الابراج*')
database:set(bot_id.." amir:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'*𖡺︙تم تفعيل الابراج*')
...
send(msg.chat_id_, msg.id_, '*𖡺︙تم تعطيل حساب العمر*')
...
send(msg.chat_id_, msg.id_,'*𖡺︙تم تفعيل حساب العمر*')
...
File:write(t)
File:close()
sendDocument(SUDO, msg.id_,0, 1, nil, './'..bot_id..'.json', '*𖡺︙عدد مجموعات التي في البوت* { '..#list..'}')
...
local Text ='*𖡺︙تم اختيار المقطع الصوتي لك*'
keyboard = {} 
keyboard.inline_keyboard = {
...
t =[[
*رابط الحذف في جميع مواقع التواصل 𖡺
فكر قبل لا تتسرع وتروح*
ٴ*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*ٴ
 *𖡺 رابط حذف*  [Telegram](https://my.telegram.org/auth?to=delete) ܁
 *𖡺 رابط حذف* [instagram](https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/) ܁
 *𖡺 رابط حذف* [Facebook](https://www.facebook.com/help/deleteaccount) ܁
 *𖡺 رابط حذف* [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
SendText(msg.chat_id_,msg.id_,"*𖡺︙المعرف غير صحيح \n*")   
return false  end   
...
send(msg.chat_id_, msg.id_,' *𖡺︙تم حذف الامر*')  
else
send(msg.chat_id_, msg.id_,' *𖡺︙لا يوجد امر بهاذا الاسم*')  
end
...
send(msg.chat_id_, msg.id_, ' *𖡺︙تم تعطيل اوامر التحشيش*')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التحشيش") then 
send(msg.chat_id_, msg.id_, '  *𖡺︙تم تفعيل اوامر التحشيش*')
...
send(msg.chat_id_,0,''..t..'\n*•━━━━━━ 𝙧𝙖𝙣 ━━━━━━━•*\n*𖡺︙تم التعديل على الميديا*\n*𖡺︙الشخص الي قام بالتعديل*\n*𖡺︙ايدي الشخص ◂ '..result.sender_user_id_..'*\n*𖡺︙معرف الشخص»{ '..users..' }*') 
end,nil)
...
if RAN1_Msg then
send(msg.chat_id_, msg.id_," 𖡺︙"..RAN1_Msg)
